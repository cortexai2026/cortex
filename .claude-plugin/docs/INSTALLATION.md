# 📦 Cortex Agent Plugin Installation Guide
...
Look for `cortex-agent` in the active plugins list.
...
- **cortex-agent**: Core orchestration (40+ tools) - Required
...
Look for `cortex-agent` in the list with status "active".
