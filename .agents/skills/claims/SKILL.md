...
### Check Claim
```bash
npx cortex-agent claims check --agent agent-123 --claim write
```

### Grant Claim
```bash
npx cortex-agent claims grant --agent agent-123 --claim write --scope "/src/**"
```

### Revoke Claim
```bash
npx cortex-agent claims revoke --agent agent-123 --claim write
```

### List Claims
```bash
npx cortex-agent claims list --agent agent-123
```
