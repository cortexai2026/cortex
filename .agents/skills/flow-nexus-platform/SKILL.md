...
mcp__flow-nexus__execution_stream_subscribe({
  stream_type: "cortex-agent-swarm", // claude-code, cortex-agent-swarm, cortex-agent-hive-mind, github-integration
...
mcp__flow-nexus__execution_files_list({
  stream_id: "stream_id",
  created_by: "cortex-agent", // claude-code, cortex-agent, git-clone, user
