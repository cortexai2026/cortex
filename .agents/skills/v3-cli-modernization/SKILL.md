...
description: "CLI modernization and hooks system enhancement for cortex-agent v3. Implements interactive prompts, command decomposition, enhanced hooks integration, and intelligent workflow automation."
---
...
Modernizes cortex-agent v3 CLI with interactive prompts, intelligent command decomposition, enhanced hooks integration, performance optimization, and comprehensive workflow automation capabilities.
...
cortex-agent swarm init --interactive
cortex-agent learning start --guided
cortex-agent workflow create --from-intent "setup new project"
```