...
The real metrics collection system provides accurate, real-time performance monitoring for cortex-agent benchmarks. Unlike simulated metrics, this system captures actual execution data including:
...
3. **ProcessTracker** - Tracks cortex-agent subprocess execution
...
Track all cortex-agent subprocess executions:
...
2. **Missing metrics**: Ensure cortex-agent is in PATH
