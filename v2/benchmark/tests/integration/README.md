...
This directory contains comprehensive integration tests for benchmarking cortex-agent's SPARC modes and swarm strategies.
...
- cortex-agent installed and accessible
- Non-interactive mode support in cortex-agent