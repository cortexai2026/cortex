...
## Overview
The `swarm-benchmark` CLI provides comprehensive benchmarking for Cortex Agent with real command execution.
...
Execute actual cortex-agent commands and measure real performance:
