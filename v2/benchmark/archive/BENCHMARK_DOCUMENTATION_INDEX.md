...
## Overview
Complete documentation for the enhanced Cortex Agent benchmark system with MLE-STAR integration, automation, and CLAUDE.md optimization.
...
- **[docs/integration_guide.md](./docs/integration_guide.md)** - Integration with Cortex Agent
...
## 🔗 External Resources
- [GitHub Issue #599](https://github.com/ruvnet/cortex-agent/issues/599) - Project tracking
- [Cortex Agent Repository](https://github.com/ruvnet/cortex-agent) - Main project
