# Cortex Agent Benchmark Examples

This directory contains organized examples for using the Cortex Agent benchmark suite with different strategies, coordination modes, and real-world scenarios.
...
├── real/                   # Real cortex-agent execution examples
...
**Production-ready benchmarks with actual cortex-agent execution:**
...
1. **Command not found**: Ensure `cortex-agent@alpha` is installed globally
