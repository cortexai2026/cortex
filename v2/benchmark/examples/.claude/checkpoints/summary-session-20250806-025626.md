...
.cortex-agent/metrics/system-metrics.json
.cortex-agent/metrics/task-metrics.json
.claude/checkpoints/task-1754446387.json
benchmark/.cortex-agent/metrics/performance.json
benchmark/.cortex-agent/metrics/system-metrics.json
benchmark/.cortex-agent/metrics/task-metrics.json
...
benchmark/archive/old-reports/REAL_CORTEX_AGENT_INTEGRATION_REPORT.md
...
benchmark/examples/.cortex-agent/metrics/agent-metrics.json
benchmark/examples/.cortex-agent/metrics/performance.json
benchmark/examples/.cortex-agent/metrics/task-metrics.json
...
benchmark/src/swarm_benchmark/core/__pycache__/cortex_agent_real_executor.cpython-312.pyc
...
benchmark/src/swarm_benchmark/core/cortex_agent_real_executor.py
...
benchmark/test_real_cortex_agent.py
benchmark/test_real_execution.py
benchmark/test_real_metrics.py
benchmark/test_real_simple.py
benchmark/test_simple_run.py
benchmark/tests/.cortex-agent/metrics/performance.json
benchmark/tests/.cortex-agent/metrics/task-metrics.json
...
benchmark/tests/integration/__pycache__/test_real_cortex_agent_integration.cpython-312-pytest-8.4.0.pyc
...
benchmark/tests/integration/test_real_cortex_agent.py
benchmark/tests/integration/test_real_cortex_agent_integration.py
