#!/bin/bash
# Demonstrate what the Cortex Agent Swarm creates for a REST API

echo "🐝 Cortex Agent Swarm - REST API Creation Demo"
echo "==========================================="
echo ""
echo "This demonstrates what the swarm system creates when you run:"
echo "./bin/cortex-agent swarm \"Build a REST API in examples/\" --strategy development"
echo ""
...
echo "   npm start"
echo ""
echo "This is what the Cortex Agent Swarm system creates when you run:"
echo "./bin/cortex-agent swarm \"Build a REST API in examples/\" --strategy development"
echo ""