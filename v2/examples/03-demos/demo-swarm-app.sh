#!/bin/bash
# Demonstrate Cortex Agent Swarm creating a real application

echo "🐝 Cortex Agent Swarm - Live Demo"
echo "================================"
echo ""
...
npx cortex-agent@latest swarm "create a weather CLI app that shows current temperature" \
...
cat > "$APP_DIR/package.json" << 'EOF'
{
  "name": "weather-cli",
  "version": "1.0.0",
  "description": "Weather CLI app created by Cortex Agent Swarm",
  "main": "index.js",
  "bin": {
    "weather": "./index.js"
  },
  ...
  "keywords": ["weather", "cli", "swarm", "cortex-agent"],
 ...
 * Created by Cortex Agent Swarm System
 * 
...
async function main() {
  ...
  console.log('🌤️  Weather CLI - Created by Cortex Agent Swarm');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
A simple weather CLI application created by the Cortex Agent Swarm system.
...
The Cortex Agent Swarm system decomposed the objective "create a weather CLI app" into the following tasks:
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "This demonstration showed how the Cortex Agent Swarm system:"
