...
echo "🚀 Cortex Agent Quick API Demo"
echo "=========================="
echo ""
echo "Creating a simple TODO API with Cortex Agent..."
echo ""

# Navigate to examples directory to use ../cortex-agent
cd "$(dirname "$0")/../.."

# Create the API using swarm
echo "📦 Initializing swarm..."
if ../cortex-agent swarm create "Build a TODO API with GET, POST, PUT, DELETE endpoints" \
