# Cortex Agent Examples

This directory contains examples demonstrating various features and capabilities of the Cortex Agent system, organized by category.
...
1. **New to Cortex Agent?** Start with `01-configurations/basic-config.json`
...
### 01. Configurations
System and workflow configuration files showing how to set up Cortex Agent for different use cases.
...
### 04. Testing
Scripts for testing Cortex Agent features, SPARC modes, and system functionality.
...
For configuration examples, use them with Cortex Agent commands:
```bash
cd examples
../cortex-agent swarm create "Your task description" --config ./01-configurations/basic/simple-config.json
```

Or from the project root:
```bash
./cortex-agent swarm create "Your task description" --config ./examples/01-configurations/basic/simple-config.json
```
