...
# Cortex Agent Examples - Quick Start Guide
# This script demonstrates the new organized example structure

echo "🚀 Cortex Agent Examples - Quick Start"
echo "===================================="
echo ""
...
echo "cd examples && ../cortex-agent swarm create 'Build hello world app based on simple workflow' --output ./output/hello"
echo ""
echo "# Run tests:"
echo "cd examples/04-testing/unit && ./test-memory-system.sh"
echo ""
echo "# Create your first swarm:"
echo "cd examples && ../cortex-agent swarm create 'Build a simple calculator'"
echo ""
echo "# Try SPARC TDD:"
echo "cd examples && ../cortex-agent sparc tdd 'Create user login function'"
echo ""
