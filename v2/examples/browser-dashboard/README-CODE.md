...
└─────────────────────────────────────────────────────────────┘
                           ↓ stdio (JSON-RPC 2.0)
┌─────────────────────────────────────────────────────────────┐
│         Cortex Agent MCP Server (npx cortex-agent mcp)        │
│  • 90+ MCP tools                                            │
│  • Swarm orchestration                                      │
│  • Agent management                                         │
...
- Actual agent spawning via `mcp__cortex-agent__agents_spawn_parallel`
...
**This is a production-ready browser IDE powered by Cortex Agent MCP + Monaco Editor!** 🚀
