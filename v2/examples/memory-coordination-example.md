...
const pluginTraits = mcp__cortex-agent__memory_usage {
  action: "retrieve",
  key: "swarm/shared/plugin-traits",
  namespace: "coordination"
}
...
const traits = mcp__cortex-agent__memory_usage {
  action: "retrieve",
  key: "swarm/shared/plugin-traits",
  namespace: "coordination"
}

const security = mcp__cortex-agent__memory_usage {
  action: "retrieve",
  key: "swarm/shared/security-policies",
  namespace: "coordination"
}
...
mcp__cortex-agent__memory_usage {
  ...
  value: JSON.stringify({
    type: "api",
    bridges: {
      "cortex-agent": "McpBridge::cortex_agent()",
...
npx cortex-agent@alpha memory search "swarm/*/status" --namespace coordination

# Check progress
npx cortex-agent@alpha memory search "swarm/*/progress" --namespace coordination  

# Find blocking issues
npx cortex-agent@alpha memory search "swarm/*/waiting" --namespace coordination

# List shared components
npx cortex-agent@alpha memory search "swarm/shared/*" --namespace coordination
```
