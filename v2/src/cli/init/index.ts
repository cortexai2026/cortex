  ...
  return errorRecovery.retryWithRecovery(
    async () => {
      try {
        ...
        console.log('\n   Next steps:');
        console.log('   1. Run "cortex-agent swarm --help" to see swarm options');
        ...
        console.log('   4. Run "cortex-agent help" for all available commands');

        if (options.sparc) {
          console.log('   5. Run "cortex-agent sparc modes" to see available SPARC modes');
