...
function showConfigIntegrationHelp() {
  ...
  console.log('Usage:');
  console.log('  cortex-agent config-integration <command> [options]\\n');
  ...
  console.log('  cortex-agent config-integration setup --enable-ruv-swarm');
  console.log('  cortex-agent config-integration preset development');
  console.log('  cortex-agent config-integration sync --force');
  console.log('  cortex-agent config-integration export my-config.json');
  console.log('  cortex-agent config-integration status --verbose');
}
