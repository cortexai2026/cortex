...
',
  ...
  console.log('Usage:');
  console.log(
    '  cortex-agent ruv-swarm <command> [options]\
',
  );
...
',
  ...
  console.log('  cortex-agent ruv-swarm init --topology mesh --max-agents 8');
  console.log('  cortex-agent ruv-swarm spawn researcher --name \"AI Researcher\"');
  console.log('  cortex-agent ruv-swarm orchestrate \"Build a REST API\"');
  console.log('  cortex-agent ruv-swarm neural train --iterations 20');
  console.log('  cortex-agent ruv-swarm benchmark --type swarm');
}
...
async function handleSpawn(ctx: CommandContext) {
  if (ctx.args.length === 0) {
    ...
    console.log('Usage: cortex-agent ruv-swarm spawn <type> [--name <name>]');
...
async function handleOrchestrate(ctx: CommandContext) {
  if (ctx.args.length === 0) {
    ...
    console.log('Usage: cortex-agent ruv-swarm orchestrate \"<task description>\" [options]');
    return;
  }
