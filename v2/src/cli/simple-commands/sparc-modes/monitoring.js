...
1. **Monitoring Setup** (15 mins)
   ...
   - Store setup: \`npx cortex-agent memory store ${memoryNamespace}_monitoring_setup "..."\`
...
2. **Metric Collection** (20 mins)
   ...
   - Store metrics: \`npx cortex-agent memory store ${memoryNamespace}_metrics "..."\`
...
3. **Dashboard Creation** (15 mins)
   ...
   - Store dashboards: \`npx cortex-agent memory store ${memoryNamespace}_dashboards "..."\`
