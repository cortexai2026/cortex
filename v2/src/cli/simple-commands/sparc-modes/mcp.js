...
1. **Integration Planning** (10 mins)
   ...
   - Plan data mappings
   - Store plan: \`npx cortex-agent memory store ${memoryNamespace}_mcp_plan "..."\`
...
2. **Connection Setup** (15 mins)
   ...
   - Store config: \`npx cortex-agent memory store ${memoryNamespace}_mcp_config "..."\`
...
3. **Data Integration** (20 mins)
   ...
   - Store integration: \`npx cortex-agent memory store ${memoryNamespace}_mcp_integration "..."\`
