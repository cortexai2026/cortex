...
Learn more: https://github.com/ruvnet/cortex-agent#flow-nexus
...
- \`./cortex-agent start\`: Start the orchestration system
- \`./cortex-agent --help\`: Show all available commands
...
- Use \`./cortex-agent status\` to check system health
- Monitor with \`./cortex-agent monitor\` for real-time updates
...
### Core SPARC Commands
- \`./cortex-agent sparc modes\`: List all available SPARC development modes
- \`./cortex-agent sparc run <mode> "<task>"\`: Execute specific SPARC mode for a task
- \`./cortex-agent sparc tdd "<feature>"\`: Run complete TDD workflow using SPARC methodology
- \`./cortex-agent sparc info <mode>\`: Get detailed information about a specific mode
...
./cortex-agent sparc run spec-pseudocode "Define user authentication requirements"
\`\`\`
...
./cortex-agent sparc run spec-pseudocode "Create authentication flow pseudocode"
\`\`\`
...
./cortex-agent sparc run architect "Design authentication service architecture"
\`\`\`
...
./cortex-agent sparc tdd "implement user authentication system"
\`\`\`
...
./cortex-agent sparc run integration "integrate authentication with user management"
\`\`\`
...
- \`/cortex-agent-help\`: Show all Claude-Flow commands
- \`/cortex-agent-memory\`: Interact with memory system
- \`/cortex-agent-swarm\`: Coordinate multi-agent swarms
...
./cortex-agent memory store spec_auth "User authentication requirements and constraints"

# Store architectural decisions
./cortex-agent memory store arch_decisions "Database schema and API design choices"

# Store test results and coverage
./cortex-agent memory store test_coverage "Authentication module: 95% coverage, all tests passing"

# Query previous work
./cortex-agent memory query auth_implementation

# Export project memory
./cortex-agent memory export project_backup.json
\`\`\`
...
./cortex-agent sparc run spec-pseudocode "User profile management feature"

# 2. Design architecture
./cortex-agent sparc run architect "Profile service architecture with data validation"

# 3. Implement with TDD
./cortex-agent sparc tdd "user profile CRUD operations"

# 4. Security review
./cortex-agent sparc run security-review "profile data access and validation"

# 5. Integration testing
./cortex-agent sparc run integration "profile service with authentication system"

# 6. Documentation
./cortex-agent sparc run docs-writer "profile service API documentation"
\`\`\`

### Bug Fix Workflow
\`\`\`bash
# 1. Debug and analyze
./cortex-agent sparc run debug "authentication token expiration issue"

# 2. Write regression tests
./cortex-agent sparc run tdd "token refresh mechanism tests"

# 3. Implement fix
./cortex-agent sparc run code "fix token refresh in authentication service"

# 4. Security review
./cortex-agent sparc run security-review "token handling security implications"
\`\`\`
...
./cortex-agent sparc info <mode-name>
\`\`\`
...
- \`mcp__cortex-agent__swarm_init\` - Initialize coordination topology
- \`mcp__cortex-agent__agent_spawn\` - Define agent types for coordination
- \`mcp__cortex-agent__task_orchestrate\` - Orchestrate high-level workflows
...
### Core Commands
- \`npx cortex-agent sparc modes\` - List available modes
- \`npx cortex-agent sparc run <mode> "<task>"\` - Execute specific mode
- \`npx cortex-agent sparc tdd "<feature>"\` - Run complete TDD workflow
- \`npx cortex-agent sparc info <mode>\` - Get mode details

### Batchtools Commands
- \`npx cortex-agent sparc batch <modes> "<task>"\` - Parallel execution
- \`npx cortex-agent sparc pipeline "<task>"\` - Full pipeline processing
- \`npx cortex-agent sparc concurrent <mode> "<tasks-file>"\` - Multi-task processing
...
- Documentation: https://github.com/ruvnet/cortex-agent#flow-nexus
