...
async function runInteractiveWizard() {
  ...
  try {
    ...
    if (result.success) {
      ...
      console.log(chalk.gray('  • View status: cortex-agent hive-mind status'));
      console.log(chalk.gray('  • Monitor progress: cortex-agent hive-mind metrics'));
      console.log(chalk.gray('  • Create another swarm: cortex-agent hive-mind wizard'));
      console.log(chalk.gray('  • Learn more: cortex-agent help hive-mind\n'));
    ...
    console.log(chalk.gray('You can try manual setup with: cortex-agent hive-mind init'));
  }
}
