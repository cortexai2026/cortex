...
│   │   └── 4 main commands  # Cortex Agent integration
...
- `commands/cortex-agent-help.md` - Help and documentation
- `commands/cortex-agent-memory.md` - Memory system interaction
- `commands/cortex-agent-swarm.md` - Swarm coordination
...
- Integration with Cortex Agent orchestration
...
- Cortex Agent integration via `/cortex-agent-*`
...
1. **Integration** into Cortex Agent initialization process
