...
- **Cortex Agent integration** for orchestration
...
The template is automatically installed when initializing a new Cortex Agent project. To manually install:
...
- Main commands for Cortex Agent integration
...
- Use `/cortex-agent-*` for Cortex Agent features
...
- Refer to Cortex Agent documentation
