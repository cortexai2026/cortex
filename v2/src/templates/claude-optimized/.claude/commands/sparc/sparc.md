...
1. Run directly: `npx cortex-agent sparc run sparc-optimized "your complex task"`
...
npx cortex-agent sparc run sparc-optimized "implement complete e-commerce platform"

# Parallel multi-service implementation
npx cortex-agent sparc run sparc-optimized "create microservices architecture with 5 services"
```
