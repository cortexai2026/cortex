...
npx cortex-agent test:integration:auth & \
npx cortex-agent test:integration:data & \
npx cortex-agent test:integration:storage & \
wait
```
...
1. Run directly: `npx cortex-agent sparc run mcp-optimized "your task"`
...
npx cortex-agent sparc run mcp-optimized "integrate auth, payment, and notification services"

# Batch API configuration
npx cortex-agent sparc run mcp-optimized "configure all external service endpoints"
```
