...
1. Run directly: `npx cortex-agent sparc run tutorial "your task"`
...
npx cortex-agent sparc run tutorial "create full SPARC onboarding course with batch examples"

# Build mode-specific tutorials simultaneously
npx cortex-agent sparc run tutorial "generate tutorials for all SPARC modes in parallel"

# Create interactive workshop materials
npx cortex-agent sparc run tutorial "build hands-on SPARC workshop with concurrent exercises"
```
