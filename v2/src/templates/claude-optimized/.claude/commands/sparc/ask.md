...
1. Run directly: `npx cortex-agent sparc run ask "your task"`
...
npx cortex-agent sparc run ask "how should I implement user authentication with testing?"

# Decompose complex project into SPARC tasks
npx cortex-agent sparc run ask "help me plan a full e-commerce platform build"

# Find best mode for specific problem
npx cortex-agent sparc run ask "which mode should I use for database schema refactoring?"
```
