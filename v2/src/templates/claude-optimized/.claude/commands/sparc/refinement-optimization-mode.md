...
1. Run directly: `npx cortex-agent sparc run refinement-optimization-mode-optimized "your task"`
...
npx cortex-agent sparc run refinement-optimization-mode-optimized "optimize all modules"

# Batch refactor large files
npx cortex-agent sparc run refinement-optimization-mode-optimized "break down all files over 500 lines"
```
