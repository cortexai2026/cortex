...
npx cortex-agent sparc batch-run --modes '{
...
npx cortex-agent sparc pipeline --stages '[
...
npx cortex-agent sparc batch-tdd --features '{
...
npx cortex-agent sparc batch-analyze --components '{
...
npx cortex-agent sparc batch-spec --components '[
...
npx cortex-agent sparc batch-pseudocode --algorithms '{
...
npx cortex-agent sparc distributed-architect --services '[
...
npx cortex-agent sparc parallel-tdd --config '{
  "modules": {
...
npx cortex-agent sparc batch-integrate --components '[
...
npx cortex-agent sparc batch-memory-store --data '{
...
npx cortex-agent sparc batch-memory-query --queries '[
...
npx cortex-agent sparc swarm-batch --project "enterprise-app" --config '{
  "phases": [
    {
      "name": "design",
...
npx cortex-agent sparc distribute --analysis '{
...
npx cortex-agent sparc cache-config --settings '{
...
npx cortex-agent sparc enterprise-flow --project "fintech-platform" --parallel-config '{
  "specification": {
...
npx cortex-agent sparc migrate-batch --from "monolith" --to "microservices" --strategy '{
...
npx cortex-agent sparc ml-pipeline --config '{
  "data-pipeline": {
...
npx cortex-agent sparc monitor-batch --dashboards '[
...
npx cortex-agent sparc analyze-performance --metrics '{
