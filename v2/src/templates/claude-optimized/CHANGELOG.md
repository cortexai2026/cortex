...
- Cortex Agent integration commands:
  - cortex-agent-help - Help and documentation access
  - cortex-agent-memory - Memory system interaction
  - cortex-agent-swarm - Swarm coordination
- SPARC mode commands:
...
- Integrated with Cortex Agent orchestration
