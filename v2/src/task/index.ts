...
cortex-agent task create development "Implement user authentication system" \\
  --priority 80 \\
...
cortex-agent task status task-789 \\
  --show-logs \\
  --show-checkpoints \\
  --show-metrics \\
  --show-dependencies \\
...
cortex-agent task cancel task-789 \\
...
cortex-agent task workflow create "E-commerce Platform" \\
  --description "Complete e-commerce development workflow" \\
  --max-concurrent 8 \\
  --strategy priority-based \\
  --error-handling continue-on-error

cortex-agent task workflow execute workflow-123 \\
  --variables '{"environment":"staging","version":"2.1.0"}' \\
  --monitor

cortex-agent task workflow visualize workflow-123 \\
  --format dot \\
