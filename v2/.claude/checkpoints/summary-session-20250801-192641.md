...
CHANGELOG.md
bin/cortex-agent.js
cortex-agent-2.0.0-alpha.83.tgz
cortex-agent-wiki
package-lock.json
src/mcp/mcp-server.js
test-alpha-83/.cortex-agent/metrics/agent-metrics.json
test-alpha-83/.cortex-agent/metrics/performance.json
test-alpha-83/.cortex-agent/metrics/task-metrics.json
...
## Recent Commits
cb3a174 🔖 Checkpoint: Edit /workspaces/claude-code-flow/bin/cortex-agent.js
