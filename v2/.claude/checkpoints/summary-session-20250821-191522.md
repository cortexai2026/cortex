...
test-claude-md-update/.claude/commands/cortex-agent-help.md
test-claude-md-update/.claude/commands/cortex-agent-memory.md
test-claude-md-update/.claude/commands/cortex-agent-swarm.md
...
8ca960c5 🔖 Checkpoint: Edit /workspaces/claude-code-flow/bin/cortex-agent.js
