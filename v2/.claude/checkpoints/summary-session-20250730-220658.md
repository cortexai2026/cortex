...
## Files Modified
.cortex-agent/metrics/agent-metrics.json
...
test-monitoring/.cortex-agent/env-setup.sh
test-monitoring/.cortex-agent/monitoring.config.json
test-monitoring/.cortex-agent/token-usage.json
