...
npx cortex-agent sparc run spec-pseudocode "OAuth2 authentication system"
npx cortex-agent sparc run architect "microservices communication layer"
npx cortex-agent sparc tdd "payment processing feature"
npx cortex-agent sparc pipeline "complete feature implementation"

# Batch processing for complex goals
npx cortex-agent sparc batch spec,arch,refine "user management system"
npx cortex-agent sparc concurrent tdd tasks.json
```
...
sparc_phases:
  specification:
    command: "npx cortex-agent sparc run spec-pseudocode 'payment processing'"
    deliverables:
      - requirements_doc
      - acceptance_criteria
      - test_scenarios
  ...
  pseudocode:
    command: "npx cortex-agent sparc run pseudocode 'payment flow algorithms'"
    deliverables:
      - payment_flow_logic
  ...
  architecture:
    command: "npx cortex-agent sparc run architect 'payment system design'"
    deliverables:
      - system_components
      - api_contracts
      - database_schema
  ...
  refinement:
    command: "npx cortex-agent sparc tdd 'payment feature'"
    deliverables:
      - unit_tests
      - integration_tests
  ...
  completion:
    command: "npx cortex-agent sparc run integration 'deploy payment system'"
    deliverables:
      - deployed_system
      - documentation
      - monitoring_setup
...
npx cortex-agent sparc run spec-pseudocode "user authentication feature"

# 2. Execute architecture phase
npx cortex-agent sparc run architect "authentication system design"

# 3. TDD implementation with goal tracking
npx cortex-agent sparc tdd "authentication feature" --track-goals

# 4. Complete integration with goal validation
npx cortex-agent sparc run integration "deploy authentication" --validate-goals

# 5. Verify goal achievement
npx cortex-agent sparc verify "authentication feature complete"
```
