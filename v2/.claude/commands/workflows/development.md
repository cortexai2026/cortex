...
### 4. Monitor Progress
```
Tool: mcp__cortex-agent__task_status
...
npx cortex-agent workflow dev "REST API with auth"

# Create custom workflow
npx cortex-agent workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx cortex-agent workflow execute api-dev
```