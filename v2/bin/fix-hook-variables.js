...
export async function fixHookVariablesCommand(args = [], flags = {}) {
  ...
  if (totalChanges > 0) {
    ...
    console.log('  3. Report any issues to: https://github.com/ruvnet/cortex-agent/issues');
  }
...
export const fixHookVariablesCommandConfig = {
  ...
  examples: [
    'cortex-agent fix-hook-variables',
    'cortex-agent fix-hook-variables .claude/settings.json',
    'cortex-agent fix-hook-variables --syntax wrapper',
    'cortex-agent fix-hook-variables --test',
  ],
  details: `
...
For more information: https://github.com/ruvnet/cortex-agent/issues/249`,
};
