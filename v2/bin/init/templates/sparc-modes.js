...
\`\`\`bash
# Run a specific mode
./cortex-agent@alpha sparc run <mode> "task description"

# List all modes
./cortex-agent@alpha sparc modes

# Get help for a mode
./cortex-agent@alpha sparc help <mode>
\`\`\`
`;
}
...
mcp__cortex-agent@alpha__task_orchestrate {
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha swarm "analyze system performance" --strategy analysis
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha swarm "build feature X" --strategy development
\`\`\`
...
### Research Swarm
\`\`\`bash
./cortex-agent@alpha swarm "research AI trends" \\
  --strategy research \\
  --mode distributed \\
  --max-agents 6 \\
  --parallel
...
### Development Swarm
\`\`\`bash
./cortex-agent@alpha swarm "build REST API" \\
  --strategy development \\
  --mode hierarchical \\
  --monitor \\
  --output sqlite
...
### Analysis Swarm
\`\`\`bash
./cortex-agent@alpha swarm "analyze codebase" \\
  --strategy analysis \\
  --mode mesh \\
  --parallel \\
  --timeout 300
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha swarm "update dependencies" --strategy maintenance
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha swarm "optimize performance" --strategy optimization
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha swarm "research topic X" --strategy research
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha swarm "test application" --strategy testing
\`\`\`
...
### Option 1: Using MCP Tools (Preferred in Claude Code)
\`\`\`javascript
mcp__cortex-agent@alpha__sparc_mode {
  mode: "analyzer",
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run analyzer "analyze codebase performance"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run architect "design microservices architecture"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run batch-executor "process multiple files"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run coder "implement user authentication"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run debugger "fix authentication issues"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run designer "create dashboard UI"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run documenter "create API documentation"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run innovator "innovative solutions for scaling"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run memory-manager "organize project knowledge"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run optimizer "optimize application performance"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run orchestrator "coordinate feature development"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run researcher "research AI trends 2024"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run reviewer "review pull request #123"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run swarm-coordinator "manage development swarm"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run tdd "shopping cart feature"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run tester "full regression suite"
\`\`\`
...
\`\`\`bash
# If cortex-agent@alpha is installed locally
./cortex-agent@alpha sparc run workflow-manager "automate deployment"
\`\`\`
