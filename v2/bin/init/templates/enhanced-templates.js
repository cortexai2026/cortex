// enhanced-templates.js - Generate Cortex Agent v2.0.0 enhanced templates
...
export function createWrapperScript(type = 'unix') {
  ...
  if (type === 'unix') {
    const universalTemplate = loadTemplate('cortex-agent@alpha-universal');
  ...
  const filename = 'cortex-agent@alpha';
...
## Usage
\`\`\`bash
npx cortex-agent@alpha analysis bottleneck-detect [options]
\`\`\`
...
npx cortex-agent@alpha analysis bottleneck-detect

# Set custom threshold
npx cortex-agent@alpha analysis bottleneck-detect --threshold 500

# Export results
npx cortex-agent@alpha analysis bottleneck-detect --export bottlenecks.json
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha analysis token-usage [options]
\`\`\`
...
npx cortex-agent@alpha analysis token-usage --period 24h

# By agent breakdown
npx cortex-agent@alpha analysis token-usage --by-agent

# Export detailed report
npx cortex-agent@alpha analysis token-usage --period 7d --export tokens.csv
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha analysis performance-report [options]
\`\`\`
...
npx cortex-agent@alpha analysis performance-report --format html

# Compare swarms
npx cortex-agent@alpha analysis performance-report --compare swarm-123

# Full metrics report
npx cortex-agent@alpha analysis performance-report --include-metrics --format markdown
\`\`\`
`,
    },
    automation: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha automation auto-agent [options]
\`\`\`
...
npx cortex-agent@alpha automation auto-agent --task "Build REST API"

# Limit agents
npx cortex-agent@alpha automation auto-agent --task "Fix bugs" --max-agents 3

# Use specific strategy
npx cortex-agent@alpha automation auto-agent --strategy specialized
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha automation smart-spawn [options]
\`\`\`
...
npx cortex-agent@alpha automation smart-spawn --analyze

# Set spawn threshold
npx cortex-agent@alpha automation smart-spawn --threshold 5

# Force topology
npx cortex-agent@alpha automation smart-spawn --topology hierarchical
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha automation workflow-select [options]
\`\`\`
...
npx cortex-agent@alpha automation workflow-select --task "Deploy to production"

# With constraints
npx cortex-agent@alpha automation workflow-select --constraints "no-downtime,rollback"

# Preview mode
npx cortex-agent@alpha automation workflow-select --task "Database migration" --preview
\`\`\`
`,
    },
    coordination: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha swarm init [options]
\`\`\`
...
npx cortex-agent@alpha swarm init --topology hierarchical

# With agent limit
npx cortex-agent@alpha swarm init --topology mesh --max-agents 8

# Parallel execution
npx cortex-agent@alpha swarm init --strategy parallel
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha agent spawn [options]
\`\`\`
...
\`\`\`bash
# Spawn coder agent
npx cortex-agent@alpha agent spawn --type coder

# With custom name
npx cortex-agent@alpha agent spawn --type researcher --name "API Expert"

# With specific skills
npx cortex-agent@alpha agent spawn --type coder --skills "python,fastapi,testing"
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha task orchestrate [options]
\`\`\`
...
npx cortex-agent@alpha task orchestrate --task "Implement user authentication"

# High priority task
npx cortex-agent@alpha task orchestrate --task "Fix production bug" --priority critical

# With specific strategy
npx cortex-agent@alpha task orchestrate --task "Refactor codebase" --strategy parallel
\`\`\`
`,
    },
    github: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha github swarm [options]
\`\`\`
...
\`\`\`bash
# Create GitHub swarm
npx cortex-agent@alpha github swarm --repository myorg/myrepo

# With specific focus
npx cortex-agent@alpha github swarm --repository myorg/myrepo --focus security

# Custom agent count
npx cortex-agent@alpha github swarm --repository myorg/myrepo --agents 6
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha github repo-analyze [options]
\`\`\`
...
\`\`\`bash
# Basic analysis
npx cortex-agent@alpha github repo-analyze --repository myorg/myrepo

# Deep analysis
npx cortex-agent@alpha github repo-analyze --repository myorg/myrepo --deep

# Specific areas
npx cortex-agent@alpha github repo-analyze --repository myorg/myrepo --include issues,prs
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha github pr-enhance [options]
\`\`\`
...
\`\`\`bash
# Enhance PR
npx cortex-agent@alpha github pr-enhance --pr-number 123

# Add tests
npx cortex-agent@alpha github pr-enhance --pr-number 123 --add-tests

# Full enhancement
npx cortex-agent@alpha github pr-enhance --pr-number 123 --add-tests --improve-docs
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha github issue-triage [options]
\`\`\`
...
\`\`\`bash
# Triage issues
npx cortex-agent@alpha github issue-triage --repository myorg/myrepo

# With auto-labeling
npx cortex-agent@alpha github issue-triage --repository myorg/myrepo --auto-label

# Full automation
npx cortex-agent@alpha github issue-triage --repository myorg/myrepo --auto-label --assign
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha github code-review [options]
\`\`\`
...
\`\`\`bash
# Review PR
npx cortex-agent@alpha github code-review --pr-number 456

# Security focus
npx cortex-agent@alpha github code-review --pr-number 456 --focus security

# With fix suggestions
npx cortex-agent@alpha github code-review --pr-number 456 --suggest-fixes
\`\`\`
`,
    },
    hooks: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha hook pre-task [options]
\`\`\`
...
\`\`\`bash
# Basic pre-task hook
npx cortex-agent@alpha hook pre-task --description "Building API endpoints"

# With auto-spawn
npx cortex-agent@alpha hook pre-task --description "Complex refactoring" --auto-spawn-agents

# Load context
npx cortex-agent@alpha hook pre-task --description "Continue feature" --load-context
\`\`\`
`,
      'post-task': `# post-task
...
## Usage
\`\`\`bash
npx cortex-agent@alpha hook post-task [options]
\`\`\`
...
\`\`\`bash
# Basic post-task
npx cortex-agent@alpha hook post-task --task-id task-123

# With performance analysis
npx cortex-agent@alpha hook post-task --task-id task-123 --analyze-performance

# Update memory
npx cortex-agent@alpha hook post-task --task-id task-123 --update-memory
\`\`\`
`,
      'pre-edit': `# pre-edit
...
## Usage
\`\`\`bash
npx cortex-agent@alpha hook pre-edit [options]
\`\`\`
...
\`\`\`bash
# Pre-edit hook
npx cortex-agent@alpha hook pre-edit --file src/api.js

# With validation
npx cortex-agent@alpha hook pre-edit --file src/api.js --validate-syntax

# Create backup
npx cortex-agent@alpha hook pre-edit --file src/api.js --backup
\`\`\`
`,
      'post-edit': `# post-edit
...
## Usage
\`\`\`bash
npx cortex-agent@alpha hook post-edit [options]
\`\`\`
...
\`\`\`bash
# Post-edit hook
npx cortex-agent@alpha hook post-edit --file src/api.js

# Store in memory
npx cortex-agent@alpha hook post-edit --file src/api.js --memory-key "api-changes"

# With formatting
npx cortex-agent@alpha hook post-edit --file src/api.js --format
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha hook session-end [options]
\`\`\`
...
\`\`\`bash
# End session
npx cortex-agent@alpha hook session-end

# Export metrics
npx cortex-agent@alpha hook session-end --export-metrics

# Full closure
npx cortex-agent@alpha hook session-end --export-metrics --generate-summary --persist-state
\`\`\`
`,
    },
    memory: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha memory usage [options]
\`\`\`
...
\`\`\`bash
# Store memory
npx cortex-agent@alpha memory usage --action store --key "project-config" --value '{"api": "v2"}'

# Retrieve memory
npx cortex-agent@alpha memory usage --action retrieve --key "project-config"

# List all keys
npx cortex-agent@alpha memory usage --action list
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha memory persist [options]
\`\`\`
...
\`\`\`bash
# Export memory
npx cortex-agent@alpha memory persist --export memory-backup.json

# Import memory
npx cortex-agent@alpha memory persist --import memory-backup.json

# Compressed export
npx cortex-agent@alpha memory persist --export memory.gz --compress
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha memory search [options]
\`\`\`
...
\`\`\`bash
# Search memory
npx cortex-agent@alpha memory search --query "authentication"

# Pattern search
npx cortex-agent@alpha memory search --pattern "api-.*"

# Limited results
npx cortex-agent@alpha memory search --query "config" --limit 10
\`\`\`
`,
    },
    monitoring: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha swarm monitor [options]
\`\`\`
...
\`\`\`bash
# Start monitoring
npx cortex-agent@alpha swarm monitor

# Custom interval
npx cortex-agent@alpha swarm monitor --interval 5000

# With metrics
npx cortex-agent@alpha swarm monitor --metrics
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha agent metrics [options]
\`\`\`
...
\`\`\`bash
# All agents metrics
npx cortex-agent@alpha agent metrics

# Specific agent
npx cortex-agent@alpha agent metrics --agent-id agent-001

# Last hour
npx cortex-agent@alpha agent metrics --period 1h
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha monitoring real-time-view [options]
\`\`\`
...
npx cortex-agent@alpha monitoring real-time-view

# Filter errors
npx cortex-agent@alpha monitoring real-time-view --filter errors

# Highlight pattern
npx cortex-agent@alpha monitoring real-time-view --highlight "API"
\`\`\`
`,
    },
    optimization: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha optimization topology-optimize [options]
\`\`\`
...
\`\`\`bash
# Analyze and suggest
npx cortex-agent@alpha optimization topology-optimize --analyze-first

# Optimize for speed
npx cortex-agent@alpha optimization topology-optimize --target speed

# Apply changes
npx cortex-agent@alpha optimization topology-optimize --target efficiency --apply
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha optimization parallel-execute [options]
\`\`\`
...
\`\`\`bash
# Execute task list
npx cortex-agent@alpha optimization parallel-execute --tasks tasks.json

# Limit parallelism
npx cortex-agent@alpha optimization parallel-execute --tasks tasks.json --max-parallel 5

# Custom strategy
npx cortex-agent@alpha optimization parallel-execute --strategy adaptive
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha optimization cache-manage [options]
\`\`\`
...
\`\`\`bash
# View cache stats
npx cortex-agent@alpha optimization cache-manage --action view

# Clear cache
npx cortex-agent@alpha optimization cache-manage --action clear

# Set limits
npx cortex-agent@alpha optimization cache-manage --max-size 100 --ttl 3600
\`\`\`
`,
    },
    training: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha training neural-train [options]
\`\`\`
...
npx cortex-agent@alpha training neural-train --data recent

# Specific model
npx cortex-agent@alpha training neural-train --model task-predictor

# Custom epochs
npx cortex-agent@alpha training neural-train --epochs 100
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha training pattern-learn [options]
\`\`\`
...
\`\`\`bash
# Learn from all ops
npx cortex-agent@alpha training pattern-learn

# High success only
npx cortex-agent@alpha training pattern-learn --threshold 0.9

# Save patterns
npx cortex-agent@alpha training pattern-learn --save optimal-patterns
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha training model-update [options]
\`\`\`
...
\`\`\`bash
# Update all models
npx cortex-agent@alpha training model-update

# Specific model
npx cortex-agent@alpha training model-update --model agent-selector

# Incremental with validation
npx cortex-agent@alpha training model-update --incremental --validate
\`\`\`
`,
    },
    workflows: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha workflow create [options]
\`\`\`
...
\`\`\`bash
# Create workflow
npx cortex-agent@alpha workflow create --name "deploy-api"

# From history
npx cortex-agent@alpha workflow create --name "test-suite" --from-history

# Interactive mode
npx cortex-agent@alpha workflow create --interactive
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha workflow execute [options]
\`\`\`
...
\`\`\`bash
# Execute workflow
npx cortex-agent@alpha workflow execute --name "deploy-api"

# With parameters
npx cortex-agent@alpha workflow execute --name "test-suite" --params '{"env": "staging"}'

# Dry run
npx cortex-agent@alpha workflow execute --name "deploy-api" --dry-run
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha workflow export [options]
\`\`\`
...
\`\`\`bash
# Export workflow
npx cortex-agent@alpha workflow export --name "deploy-api"

# As YAML
npx cortex-agent@alpha workflow export --name "test-suite" --format yaml

# With history
npx cortex-agent@alpha workflow export --name "deploy-api" --include-history
\`\`\`
`,
    },
    swarm: {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha swarm <objective> [options]
\`\`\`
...
\`\`\`bash
# Basic swarm
npx cortex-agent@alpha swarm "Build REST API"

# With strategy
npx cortex-agent@alpha swarm "Research AI patterns" --strategy research

# Open in Claude Code
npx cortex-agent@alpha swarm "Build API" --claude
\`\`\`
`,
      'swarm-init': `# swarm-init
...
## Examples
\`\`\`bash
npx cortex-agent@alpha swarm init --topology mesh
npx cortex-agent@alpha swarm init --topology hierarchical --max-agents 8
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha swarm spawn [options]
\`\`\`
...
## Examples
\`\`\`bash
npx cortex-agent@alpha swarm spawn --type coder --count 3
npx cortex-agent@alpha swarm spawn --type researcher --capabilities "web-search,analysis"
\`\`\`
`,
    },
    'hive-mind': {
...
## Usage
\`\`\`bash
npx cortex-agent@alpha hive-mind [subcommand] [options]
\`\`\`
...
# Spawn swarm
npx cortex-agent@alpha hive-mind spawn "Build microservices"
...
## Usage
\`\`\`bash
npx cortex-agent@alpha hive-mind init [options]
\`\`\`
...
\`\`\`bash
npx cortex-agent@alpha hive-mind init
npx cortex-agent@alpha hive-mind init --force
\`\`\`
`,
...
## Usage
\`\`\`bash
npx cortex-agent@alpha hive-mind spawn <objective> [options]
\`\`\`
...
## Examples
\`\`\`bash
npx cortex-agent@alpha hive-mind spawn "Build API"
npx cortex-agent@alpha hive-mind spawn "Research patterns" --queen-type adaptive
npx cortex-agent@alpha hive-mind spawn "Build service" --claude
\`\`\`
`,
    },
    agents: {
...
Complete guide to all 54 available agent types in Cortex Agent.
...
npx cortex-agent@alpha agents capabilities

# For specific agent
npx cortex-agent@alpha agents capabilities --type coder
\`\`\`
`,
...
\`\`\`bash
npx cortex-agent@alpha swarm init --topology adaptive
\`\`\`
...
\`\`\`javascript
mcp__cortex-agent@alpha__swarm_init { topology: "mesh" }
mcp__cortex-agent@alpha__agent_spawn { type: "researcher" }
\`\`\`
...
claude mcp add cortex-agent@alpha npx cortex-agent@alpha mcp start

echo "✅ MCP server setup complete!"
echo "🎯 You can now use mcp__cortex-agent@alpha__ tools in Claude Code"
`,
    'quick-start.sh': `#!/bin/bash
# Quick start guide for Cortex Agent

echo "🚀 Cortex Agent Quick Start"
echo "=========================="
echo ""
echo "1. Initialize a swarm:"
echo "   npx cortex-agent@alpha swarm init --topology hierarchical"
echo ""
echo "2. Spawn agents:"
echo "   npx cortex-agent@alpha agent spawn --type coder --name \"API Developer\""
echo ""
echo "3. Orchestrate tasks:"
echo "   npx cortex-agent@alpha task orchestrate --task \"Build REST API\""
echo ""
echo "4. Monitor progress:"
echo "   npx cortex-agent@alpha swarm monitor"
echo ""
...
echo "  - npx cortex-agent@alpha github swarm"
echo "  - npx cortex-agent@alpha repo analyze"
echo "  - npx cortex-agent@alpha pr enhance"
echo "  - npx cortex-agent@alpha issue triage"
`,
...
/**
 * Cortex Agent CLI - Universal Wrapper
...
(async () => {
  ...
  // Try multiple strategies to find cortex-agent@alpha
  const strategies = [
    // 1. Local node_modules
    async () => {
      try {
        const localPath = resolve(process.cwd(), 'node_modules/.bin/cortex-agent@alpha');
    ...
    async () => {
      try {
        const parentPath = resolve(process.cwd(), '../node_modules/.bin/cortex-agent@alpha');
        const { existsSync } = await import('fs');
    ...
    async () => {
      return spawn('npx', ['cortex-agent@alpha@2.0.0-alpha.25', ...process.argv.slice(2)], { stdio: 'inherit' });
    }
  ];
  ...
  console.error('Could not find cortex-agent@alpha. Please install it with: npm install cortex-agent@alpha');
  process.exit(1);
})();`;
  } else if (type === 'windows') {
    return `@echo off
rem Cortex Agent wrapper script for Windows
...
if exist "%~dp0package.json" (
    ...
    if exist "%~dp0src\\cli\\simple-cli.js" (
        ...
        echo Error: Could not find Cortex Agent CLI files
        exit /b 1
    )
) else (
    rem Production mode - use npx alpha
    npx cortex-agent@alpha %*
)`;
  } else if (type === 'powershell') {
    return `# Cortex Agent wrapper script for PowerShell
...
if (Test-Path "$scriptPath\\package.json") {
    ...
    if (Test-Path "$scriptPath\\src\\cli\\simple-cli.js") {
        ...
        Write-Error "Could not find Cortex Agent CLI files"
        exit 1
    }
} else {
    # Production mode - use npx alpha
    & npx cortex-agent@alpha $args
}`;
  }
  return '';
}
...
function createEnhancedClaudeMdFallback() {
  ...
  try {
    ...
    return `# Claude Code Configuration for Cortex Agent

## 🚀 IMPORTANT: Cortex Agent AI-Driven Development
...
1. Add MCP server: \`claude mcp add cortex-agent@alpha npx cortex-agent@alpha mcp start\`
2. Initialize swarm: \`mcp__cortex-agent@alpha__swarm_init { topology: "hierarchical" }\`
3. Spawn agents: \`mcp__cortex-agent@alpha__agent_spawn { type: "coder" }\`
4. Orchestrate: \`mcp__cortex-agent@alpha__task_orchestrate { task: "Build feature" }\`
...
function createEnhancedSettingsJsonFallback() {
  return JSON.stringify(
    {
      env: {
        CORTEX_AGENT_AUTO_COMMIT: 'false',
        CORTEX_AGENT_AUTO_PUSH: 'false',
        CORTEX_AGENT_HOOKS_ENABLED: 'true',
        CORTEX_AGENT_TELEMETRY_ENABLED: 'true',
        CORTEX_AGENT_REMOTE_EXECUTION: 'true',
        CORTEX_AGENT_CHECKPOINTS_ENABLED: 'true',
      },
      permissions: {
        allow: [
          'Bash(npx cortex-agent@alpha *)',
          'Bash(npm run lint)',
          'Bash(npm run test:*)',
          'Bash(npm test *)',
          'Bash(git status)',
      ...
      enabledMcpjsonServers: ['cortex-agent@alpha', 'ruv-swarm'],
      hooks: {
        PreToolUse: [
          {
            matcher: 'Bash',
            hooks: [
              {
                type: 'command',
                command:
                  'cat | jq -r \'.tool_input.command // ""\' | xargs -I {} npx cortex-agent@alpha hooks pre-command --command "{}" --validate-safety true --prepare-resources true',
              },
            ],
          },
          {
            ...
            hooks: [
              {
                type: 'command',
                command:
                  'cat | jq -r \'.tool_input.file_path // .tool_input.path // ""\' | xargs -I {} npx cortex-agent@alpha hooks pre-edit --file "{}" --auto-assign-agents true --load-context true',
              },
              {
                type: 'command',
            ...
            hooks: [
              {
                type: 'command',
                command:
                  'cat | jq -r \'.tool_input.command // ""\' | xargs -I {} npx cortex-agent@alpha hooks post-command --command "{}" --track-metrics true --store-results true',
              },
            ],
          },
          {
            ...
            hooks: [
              {
                type: 'command',
                command:
                  'cat | jq -r \'.tool_input.file_path // .tool_input.path // ""\' | xargs -I {} npx cortex-agent@alpha hooks post-edit --file "{}" --format true --update-memory true --train-neural true',
              },
              {
                type: 'command',
            ...
            hooks: [
              {
                type: 'command',
                command:
                  '/usr/bin/env bash -c \'if command -v npx >/dev/null 2>&1; then npx cortex-agent@alpha hooks session-end --generate-summary true --persist-state true --export-metrics true; else echo "⚠️  npx not available, skipping Cortex Agent session-end hook"; fi\'',
              },
              {
                type: 'command',
