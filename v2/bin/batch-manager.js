...
async function createInteractiveConfig(outputFile) {
  ...
  try {
    ...
    console.log(`4. Run: cortex-agent init --config ${outputFile}`);
  } catch (error) {
...
function showBatchManagerHelp() {
  ...
  console.log('USAGE:');
  console.log('  cortex-agent batch <command> [options]\n');
  ...
  console.log('  cortex-agent batch create-config my-batch.json');
  console.log('  cortex-agent batch create-config --interactive');
  console.log('  cortex-agent batch validate-config my-batch.json');
  console.log('  cortex-agent batch estimate my-batch.json');
  console.log('  cortex-agent batch list-templates');
  console.log('  cortex-agent batch list-environments\n');

  console.log('INTEGRATION:');
  console.log('  Use created configs with: cortex-agent init --config <file>');
  console.log('  Or batch init directly: cortex-agent init --batch-init project1,project2');
}
