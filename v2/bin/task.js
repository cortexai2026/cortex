...
async function createTask(subArgs, flags) {
  ...
  const tasksDir = '.cortex-agent/tasks';
...
async function listTasks(subArgs, flags) {
  ...
  if (queue.length > 0) {
    ...
    console.log('\nTo create tasks:');
    console.log('  cortex-agent task create research "Market analysis"');
    console.log('  cortex-agent task create code "Implement API"');
    console.log('  cortex-agent task create analysis "Data processing"');
  }
}
...
function showTaskHelp() {
  ...
  console.log('  cortex-agent task create research "Market analysis" --priority 8');
  console.log('  cortex-agent task list --filter running');
  console.log('  cortex-agent task workflow examples/development-workflow.json');
  console.log('  cortex-agent task coordination status');
}
