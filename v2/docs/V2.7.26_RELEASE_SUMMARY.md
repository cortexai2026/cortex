# cortex-agent v2.7.26 - Final Release Summary
...
- `cortex-agent@2.7.26` - Production-ready with clean UX
...
npx cortex-agent@alpha memory export output.json     # ✅
npx cortex-agent@alpha memory import data.json       # ✅
```
...
**Debugging:**
- Enable verbose logging: `DEBUG=* npx cortex-agent@alpha`
- Check database: `sqlite3 .swarm/memory.db`
- Verify embeddings: Check console logs
- Monitor npm: `npm view cortex-agent`
