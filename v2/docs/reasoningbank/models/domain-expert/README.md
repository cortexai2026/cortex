...
npx cortex-agent@alpha memory search "kubernetes resource optimization" --reasoningbank --namespace domain-expert

# GDPR compliance implementation
npx cortex-agent@alpha memory search "GDPR right to erasure" --reasoningbank --namespace domain-expert

# API rate limiting strategies
npx cortex-agent@alpha memory search "API rate limiting high traffic" --reasoningbank --namespace domain-expert
```
...
npx cortex-agent@alpha memory search "CI/CD security scanning" --reasoningbank --namespace domain-expert

# Data Engineering + Performance
npx cortex-agent@alpha memory search "real-time ETL performance" --reasoningbank --namespace domain-expert
```
...
- Community: Cortex Agent Discord
