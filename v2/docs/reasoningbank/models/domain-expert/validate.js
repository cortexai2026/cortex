...
\`\`\`bash
npx cortex-agent@alpha memory search "kubernetes autoscaling" \\
  --namespace domain-expert --reasoningbank --limit 5
\`\`\`

### Query Security patterns
\`\`\`bash
npx cortex-agent@alpha memory search "OAuth 2.0 security" \\
  --namespace domain-expert --reasoningbank --limit 5
\`\`\`

### Query Performance patterns
\`\`\`bash
npx cortex-agent@alpha memory search "database query optimization" \\
  --namespace domain-expert --reasoningbank --limit 5
\`\`\`
