...
- ✅ **Memory coordination** between agents via cortex-agent
...
### Schema Compliance
All models include **10 required tables** for full cortex-agent compatibility:
...
3. Query: `npx cortex-agent@alpha memory query "your question"`
...
# Query patterns
npx cortex-agent@alpha memory query "API optimization"
...
**Coordination**:
- Memory coordination via `cortex-agent@alpha memory store`
...
**Coordination**: cortex-agent@alpha memory system
