# Release Summary - cortex-agent v2.7.1
...
**GitHub Issue**: [#827](https://github.com/ruvnet/cortex-agent/issues/827)
...
cortex-agent --version  # Should show: v2.7.1
```
...
```bash
# Train a pattern
cortex-agent hooks neural-train --pattern-type coordination --epochs 50

# Retrieve patterns
cortex-agent hooks neural-patterns --action analyze

# Get statistics
cortex-agent hooks neural-patterns --action stats --pattern-type coordination
```

### Resources
- **npm**: https://www.npmjs.com/package/cortex-agent
- **GitHub**: https://github.com/ruvnet/claude-code-flow
- **Issue #827**: https://github.com/ruvnet/cortex-agent/issues/827
- **Documentation**: https://github.com/ruvnet/cortex-agent/tree/main/docs
