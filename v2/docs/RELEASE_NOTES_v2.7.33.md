# Release Notes: Cortex Agent v2.7.33
...
### Overview
Full implementation of MCP (Model Context Protocol) 2025-11 specification, aligning Cortex Agent with Anthropic's latest standards for AI model interaction.
...
npm install cortex-agent@2.7.33
...
```bash
# Update package
npm update cortex-agent

# Or reinstall
npm install cortex-agent@2.7.33

# Verify version
npx cortex-agent --version  # Should show v2.7.33
```
...
npx cortex-agent mcp start --mcp2025 --transport stdio
```
...
2. Include version (`npx cortex-agent --version`)
...
Cortex Agent v2.7.33 is a **major feature release** that brings:
...
**This release positions Cortex Agent as an industry-leading AI agent orchestration platform** with cutting-edge features, massive performance improvements, and enterprise-grade reliability.
