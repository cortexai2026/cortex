...
- ❌ **Line 133**: `./bin/cortex-agent --version` - Binary exists at this path
...
- **CI/CD**: Uses `./bin/cortex-agent` (correct)
...
- CI/CD Pipeline: https://github.com/ruvnet/cortex-agent/actions/runs/19621632521
- Rollback Manager: https://github.com/ruvnet/cortex-agent/actions/runs/19622456012
- Integration Tests: https://github.com/ruvnet/cortex-agent/actions/runs/19622447176
