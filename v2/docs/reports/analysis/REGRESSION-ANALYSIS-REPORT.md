...
#### 3.2 Agent Run
**Command**: `cortex-agent agent run coder "test task" --dry-run`
...
#### 3.3 Agent Help
**Command**: `cortex-agent agent --help`
...
#### 4.1 Booster Help
**Command**: `cortex-agent agent booster help`
...
#### 4.2 Booster Edit
**Command**: `cortex-agent agent booster edit tests/benchmark/test.js "Add JSDoc comments" --dry-run`
...
**Command**: `cortex-agent agent booster benchmark --iterations 5`
...
**Command**: `cortex-agent sparc modes`
...
#### 6.1 Hooks
**Command**: `cortex-agent hooks --help`
...
#### 6.2 Memory
**Command**: `cortex-agent memory list`
...
- CLI Access: `cortex-agent agent booster <command>`
...
# Core commands
cortex-agent agent list                                    # ✅ Working
cortex-agent agent run coder "test task" --dry-run        # ✅ Working
cortex-agent hooks --help                                  # ✅ Working
cortex-agent memory list                                   # ✅ Working

# Agent Booster
cortex-agent agent booster help                            # ✅ Working (58 lines)
cortex-agent agent booster edit <file> --dry-run          # ✅ 0ms
cortex-agent agent booster benchmark --iterations 5        # ✅ 352x validated

# Help text
cortex-agent --help                                        # ✅ Working
cortex-agent agent --help                                  # ✅ Agent Booster visible
```
