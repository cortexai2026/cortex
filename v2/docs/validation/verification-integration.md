...
cortex-agent swarm "Build REST API" --verify
...
cortex-agent swarm "Build feature" \
  -p \
...
```bash
# View training data
cat .cortex-agent/training/verification-data.jsonl
...
./cortex-agent swarm "Implement user authentication" --verify
