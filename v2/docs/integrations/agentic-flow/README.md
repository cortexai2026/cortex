...
```bash
# Install agentic-flow (automatically included in cortex-agent)
...
- **[AgentDB Integration](../../agentdb/)** - AgentDB v1.3.9 integration in cortex-agent
- **[ReasoningBank Architecture](../../reasoningbank/architecture.md)** - ReasoningBank system design
- **[Integration Architecture](../reasoningbank/REASONINGBANK_ARCHITECTURE.md)** - How cortex-agent uses agentic-flow
...
2. **Recommended Approach**: Let cortex-agent manage integration
   - Don't pin agentic-flow version
   - Trust semver for backwards compatibility
   - Update cortex-agent to get agentic-flow updates
...
All improvements automatically benefit cortex-agent users:
...
- **Claude-flow integration**: [ruvnet/cortex-agent/issues](https://github.com/ruvnet/cortex-agent/issues)
...
**Note**: For cortex-agent users, run `npm update` in the cortex-agent directory.
...
*This documentation is part of the cortex-agent project.*
