...
This branch implements **three major feature sets** that align Cortex Agent with industry best practices:
...
2. **Binary Packaging** - `bin/cortex-agent` with version v2.7.32
