# Cortex Agent MCP Tools Reference

This document provides a comprehensive reference for all 112 MCP (Model Context Protocol) tools available in the Cortex Agent ecosystem.

## Overview

Cortex Agent integrates with two MCP tool providers:
- **cortex-agent tools**: 87 tools for core functionality
...
## Cortex Agent Tools (87 tools)

The cortex-agent tools are organized into 8 categories providing comprehensive development, coordination, and system management capabilities.
...
#### `mcp__cortex-agent__agent_metrics`
...
#### `mcp__cortex-agent__topology_optimize`
...
#### `mcp__cortex-agent__load_balance`
...
#### `mcp__cortex-agent__coordination_sync`
...
#### `mcp__cortex-agent__swarm_scale`
...
#### `mcp__cortex-agent__swarm_destroy`
...
#### `mcp__cortex-agent__neural_status`
...
#### `mcp__cortex-agent__neural_patterns`
...
#### `mcp__cortex-agent__neural_predict`
...
#### `mcp__cortex-agent__wasm_optimize`
...
#### `mcp__cortex-agent__inference_run`
...
#### `mcp__cortex-agent__pattern_recognize`
...
#### `mcp__cortex-agent__cognitive_analyze`
...
#### `mcp__cortex-agent__learning_adapt`
...
#### `mcp__cortex-agent__neural_compress`
...
#### `mcp__cortex-agent__ensemble_create`
...
#### `mcp__cortex-agent__transfer_learn`
...
#### `mcp__cortex-agent__neural_explain`
...
#### `mcp__cortex-agent__memory_search`
...
#### `mcp__cortex-agent__memory_namespace`
...
#### `mcp__cortex-agent__memory_backup`
...
#### `mcp__cortex-agent__memory_restore`
...
#### `mcp__cortex-agent__memory_compress`
...
#### `mcp__cortex-agent__memory_sync`
...
#### `mcp__cortex-agent__cache_manage`
...
#### `mcp__cortex-agent__context_restore`
...
#### `mcp__cortex-agent__memory_analytics`
...
#### `mcp__cortex-agent__performance_report`
...
#### `mcp__cortex-agent__bottleneck_analyze`
...
#### `mcp__cortex-agent__token_usage`
...
#### `mcp__cortex-agent__task_status`
...
#### `mcp__cortex-agent__task_results`
...
#### `mcp__cortex-agent__benchmark_run`
...
#### `mcp__cortex-agent__metrics_collect`
...
#### `mcp__cortex-agent__trend_analysis`
...
#### `mcp__cortex-agent__cost_analysis`
...
#### `mcp__cortex-agent__quality_assess`
...
#### `mcp__cortex-agent__error_analysis`
...
#### `mcp__cortex-agent__usage_stats`
...
#### `mcp__cortex-agent__workflow_create`
...
#### `mcp__cortex-agent__workflow_execute`
...
#### `mcp__cortex-agent__workflow_export`
...
#### `mcp__cortex-agent__automation_setup`
...
#### `mcp__cortex-agent__pipeline_create`
...
#### `mcp__cortex-agent__scheduler_manage`
...
#### `mcp__cortex-agent__trigger_setup`
...
#### `mcp__cortex-agent__workflow_template`
...
#### `mcp__cortex-agent__batch_process`
...
#### `mcp__cortex-agent__parallel_execute`
...
#### `mcp__cortex-agent__github_repo_analyze`
...
#### `mcp__cortex-agent__github_pr_manage`
...
#### `mcp__cortex-agent__github_issue_track`
...
#### `mcp__cortex-agent__github_release_coord`
...
#### `mcp__cortex-agent__github_workflow_auto`
...
#### `mcp__cortex-agent__github_code_review`
...
#### `mcp__cortex-agent__github_sync_coord`
...
#### `mcp__cortex-agent__github_metrics`
...
#### `mcp__cortex-agent__daa_agent_create`
...
#### `mcp__cortex-agent__daa_capability_match`
...
#### `mcp__cortex-agent__daa_resource_alloc`
...
#### `mcp__cortex-agent__daa_lifecycle_manage`
...
#### `mcp__cortex-agent__daa_communication`
...
#### `mcp__cortex-agent__daa_consensus`
...
#### `mcp__cortex-agent__daa_optimization`
...
#### `mcp__cortex-agent__terminal_execute`
...
#### `mcp__cortex-agent__config_manage`
...
#### `mcp__cortex-agent__features_detect`
...
#### `mcp__cortex-agent__restore_system`
...
#### `mcp__cortex-agent__log_analysis`
...
#### `mcp__cortex-agent__diagnostic_run`
...
Many cortex-agent tools support batch operations for efficiency:

```json
{
  "tool": "mcp__cortex-agent__parallel_execute",
  "params": {
    "operations": [
...
```json
[
  {"tool": "mcp__cortex-agent__swarm_init", "params": {"topology": "hierarchical"}},
  {"tool": "mcp__cortex-agent__agent_spawn", "params": {"type": "coordinator"}},
...
- Use `mcp__cortex-agent__parallel_execute` for concurrent operations
...
```json
{
  "workflow": [
    ...
    {
      "tool": "mcp__cortex-agent__performance_report",
