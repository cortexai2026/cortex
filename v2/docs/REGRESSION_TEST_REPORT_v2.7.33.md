# Regression Test Report - Cortex Agent v2.7.33
...
**Tests Performed:**
- `npx cortex-agent --version` → v2.7.32 (correct)
- `npx cortex-agent --help` → Shows full help with 50+ lines (correct)
- `npx cortex-agent mcp --help` → Shows MCP subcommands (correct)
...
**Tests Performed:**
- `npx cortex-agent mcp status` → Shows server status (correct)
- `npx cortex-agent mcp tools` → Lists 87 tools across 12 categories (correct)
...
**Tests Performed:**
- `npx cortex-agent memory stats` → Shows ReasoningBank statistics
...
**Tests Performed:**
- `npx cortex-agent hooks` → Lists all pre/post operation hooks
...
**Evidence**:
```
Cortex Agent Hooks (with .swarm/memory.db persistence):
...
**Tests Performed:**
- `npx cortex-agent sparc modes` → Lists 13 SPARC modes
...
**Tests Performed:**
- `npx cortex-agent agent list` → Shows 4 active agents
