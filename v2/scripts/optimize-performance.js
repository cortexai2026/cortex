...
/**
 * Cortex Agent Performance Optimization Script
...
class PerformanceOptimizer {
      ...
      "PreToolUse": [
        {
          ...
          "hooks": [{
            ...
            "cache": true,
            "commands": [
              "npx cortex-agent@alpha hooks pre-command --batch true",
              "npx cortex-agent@alpha memory store --batch true",
              "npx cortex-agent@alpha neural predict --cache true"
            ]
          }]
        }
      ]
  ...
  formatReport(report) {
    return `# Cortex Agent Performance Optimization Report
...
\`\`\`bash
npx cortex-agent@alpha apply-optimizations
\`\`\`
`;
  }
}
