...
```
Tool: mcp__cortex-agent__neural_status
Result: {
  "patterns": {
    "convergent": 0.92,
    "divergent": 0.87,
...
## Pattern Analysis
```
Tool: mcp__cortex-agent__neural_patterns
Parameters: {
  "action": "analyze",
...
npx cortex-agent neural train --type coordination --epochs 50

# Check neural status
npx cortex-agent neural status

# Analyze patterns
npx cortex-agent neural patterns --analyze
```