...
npx cortex-agent sparc run docs-writer "create API documentation"

# For alpha features
npx cortex-agent@alpha sparc run docs-writer "create API documentation"

# With namespace
npx cortex-agent sparc run docs-writer "your task" --namespace docs-writer

# Non-interactive mode
npx cortex-agent sparc run docs-writer "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If cortex-agent is installed locally
./cortex-agent sparc run docs-writer "create API documentation"
```
...
```bash
# Store mode-specific context
npx cortex-agent memory store "docs-writer_context" "important decisions" --namespace docs-writer

# Query previous work
npx cortex-agent memory query "docs-writer" --limit 5
```
