...
npx cortex-agent sparc run security-review "audit API security"

# For alpha features
npx cortex-agent@alpha sparc run security-review "audit API security"

# With namespace
npx cortex-agent sparc run security-review "your task" --namespace security-review

# Non-interactive mode
npx cortex-agent sparc run security-review "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If cortex-agent is installed locally
./cortex-agent sparc run security-review "audit API security"
```
...
```bash
# Store mode-specific context
npx cortex-agent memory store "security-review_context" "important decisions" --namespace security-review

# Query previous work
npx cortex-agent memory query "security-review" --limit 5
```
