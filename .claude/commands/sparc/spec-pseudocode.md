...
npx cortex-agent sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
npx cortex-agent@alpha sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx cortex-agent sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx cortex-agent sparc run spec-pseudocode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If cortex-agent is installed locally
./cortex-agent sparc run spec-pseudocode "define payment flow requirements"
```
...
```bash
# Store mode-specific context
npx cortex-agent memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx cortex-agent memory query "spec-pseudocode" --limit 5
```
