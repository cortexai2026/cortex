...
1. **Model Cache**: Enable with `CORTEX_AGENT_MODEL_CACHE_MB=512`
2. **Parallel Workers**: Enable with `CORTEX_AGENT_WORKER_PARALLEL=true`
3. **Warning Suppression**: Enable with `CORTEX_AGENT_SUPPRESS_WARNINGS=true`
