...
SPARC (Specification, Pseudocode, Architecture, Refinement, Completion) is a systematic development methodology integrated with Cortex Agent's multi-agent orchestration capabilities. It provides 17 specialized modes for comprehensive software development, from initial research through deployment and monitoring.
...
npx cortex-agent sparc run <mode> "task description"
...
npx cortex-agent sparc help <mode>

# Run with options
npx cortex-agent sparc run <mode> "task" --parallel --monitor

# Execute TDD workflow
npx cortex-agent sparc tdd "feature description"

# Batch execution
npx cortex-agent sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx cortex-agent sparc pipeline "task description"
```

### Method 3: Local Installation

**Best for**: Projects with local cortex-agent installation
...
mcp__cortex-agent__agent_spawn { type: "architect" }
mcp__cortex-agent__agent_spawn { type: "coder" }
mcp__cortex-agent__agent_spawn { type: "tester" }
mcp__cortex-agent__agent_spawn { type: "reviewer" }
```
...
Message 1: mcp__cortex-agent__agent_spawn { type: "researcher" }
Message 2: mcp__cortex-agent__agent_spawn { type: "coder" }
...
```bash
# Before work
npx cortex-agent@alpha hooks pre-task --description "implement auth"

# During work
npx cortex-agent@alpha hooks post-edit --file "auth.js"

# After work
npx cortex-agent@alpha hooks post-task --task-id "task-123"
```
...
npx cortex-agent sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx cortex-agent sparc run architect "design auth system"

# Step 3: TDD implementation
npx cortex-agent sparc tdd "user authentication feature"

# Step 4: Code review
npx cortex-agent sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx cortex-agent sparc run documenter "document auth API"
```
...
npx cortex-agent sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx cortex-agent sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx cortex-agent sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx cortex-agent sparc run reviewer "validate bug fix"
```
...
npx cortex-agent sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx cortex-agent sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx cortex-agent sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx cortex-agent sparc run tester "performance benchmarks"
```
...
npx cortex-agent sparc pipeline "e-commerce checkout feature"
...
- **NPM Package**: https://www.npmjs.com/package/cortex-agent
...
# Run specific mode
npx cortex-agent sparc run <mode> "task"

# TDD workflow
npx cortex-agent sparc tdd "feature"

# Full pipeline
npx cortex-agent sparc pipeline "task"

# Batch execution
npx cortex-agent sparc batch <modes> "task"
```
...
```javascript
// Initialize swarm
mcp__cortex-agent__swarm_init { topology: "hierarchical" }

// Execute mode
mcp__cortex-agent__sparc_mode { mode: "coder", task_description: "..." }

// Monitor progress
mcp__cortex-agent__swarm_monitor { interval: 5000 }

// Store in memory
mcp__cortex-agent__memory_usage { action: "store", key: "...", value: "..." }
```
