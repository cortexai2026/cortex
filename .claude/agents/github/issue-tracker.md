...
tools: mcp__cortex-agent__swarm_init, mcp__cortex-agent__agent_spawn, mcp__cortex-agent__task_orchestrate, mcp__cortex-agent__memory_usage, Bash, TodoWrite, Read, Write
---
...
mcp__cortex-agent__swarm_init { topology: "star", maxAgents: 3 }
mcp__cortex-agent__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__cortex-agent__agent_spawn { type: "researcher", name: "Requirements Analyst" }
mcp__cortex-agent__agent_spawn { type: "coder", name: "Implementation Planner" }
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__cortex-agent__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__cortex-agent__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__cortex-agent__agent_spawn { type: "researcher", name: "Context Gatherer" }
