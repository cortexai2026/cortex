...
- `mcp__cortex-agent__*` (all swarm coordination tools)
...
mcp__cortex-agent__agent_spawn { type: "coordinator", name: "Sync Coordinator" }
mcp__cortex-agent__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__cortex-agent__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__cortex-agent__agent_spawn { type: "tester", name: "Validation Engineer" }
...
[Single Message - Complete Synchronization]:
  ...
  mcp__cortex-agent__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
  mcp__cortex-agent__agent_spawn { type: "analyst", name: "Package Analyzer" }
  mcp__cortex-agent__agent_spawn { type: "coder", name: "Integration Coder" }
  mcp__cortex-agent__agent_spawn { type: "tester", name: "Validation Tester" }
  mcp__cortex-agent__agent_spawn { type: "reviewer", name: "Quality Reviewer" }
...
mcp__cortex-agent__swarm_init { topology: "hierarchical", maxAgents: 10 }
mcp__cortex-agent__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
mcp__cortex-agent__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__cortex-agent__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__cortex-agent__agent_spawn { type: "tester", name: "Validation Engineer" }
mcp__cortex-agent__agent_spawn { type: "reviewer", name: "Quality Assurance" }
mcp__cortex-agent__agent_spawn { type: "monitor", name: "Sync Monitor" }
...
const syncConflictResolver = async (conflicts) => {
  ...
  await mcp__cortex_agent__swarm_init({ topology: "mesh", maxAgents: 6 });
  
  // Spawn specialized conflict resolution agents
  await mcp__cortex_agent__agent_spawn({ type: "analyst", name: "Conflict Analyzer" });
  await mcp__cortex_agent__agent_spawn({ type: "coder", name: "Resolution Developer" });
  await mcp__cortex_agent__agent_spawn({ type: "reviewer", name: "Solution Validator" });
  ...
  return await mcp__cortex_agent__task_orchestrate({
...
mcp__cortex-agent__agent_spawn { type: "monitor", name: "Error Monitor" }
mcp__cortex-agent__agent_spawn { type: "analyst", name: "Failure Analyzer" }
mcp__cortex-agent__agent_spawn { type: "coder", name: "Recovery Developer" }

# Coordinate recovery procedures
mcp__cortex-agent__coordination_sync { swarmId: "error-recovery-swarm" }
