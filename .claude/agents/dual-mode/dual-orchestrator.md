...
npx cortex-agent@v3alpha memory list --namespace results
```
...
mcp__cortex-agent__memory_search  // Find patterns
mcp__cortex-agent__memory_store   // Store results
...
mcp__cortex-agent__memory_store {
...
npx cortex-agent@v3alpha hooks route --task "[your task]"
