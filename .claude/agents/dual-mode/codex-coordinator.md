...
```bash
npx cortex-agent@v3alpha swarm init --topology hierarchical --max-agents 6
```
...
mcp__cortex-agent__memory_list {
  namespace: "results"
}
```
...
# Initialize
npx cortex-agent@v3alpha swarm init --topology hierarchical --max-agents 4
