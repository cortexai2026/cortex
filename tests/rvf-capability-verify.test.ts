...
// --- Module Imports ---
import { RvfBackend } from '../v3/@cortex-agent/memory/src/rvf-backend.js';
import type { RvfBackendConfig } from '../v3/@cortex-agent/memory/src/rvf-backend.js';
import { HnswLite, cosineSimilarity } from '../v3/@cortex-agent/memory/src/hnsw-lite.js';
import { RvfEventLog } from '../v3/@cortex-agent/shared/src/events/rvf-event-log.js';
import { RvfEmbeddingCache } from '../v3/@cortex-agent/embeddings/src/rvf-embedding-cache.js';
import { RvfEmbeddingService } from '../v3/@cortex-agent/embeddings/src/rvf-embedding-service.js';
import { RvfLearningStore } from '../v3/@cortex-agent/memory/src/rvf-learning-store.js';
import { PersistentSonaCoordinator } from '../v3/@cortex-agent/memory/src/persistent-sona.js';
import { RvfMigrator } from '../v3/@cortex-agent/memory/src/rvf-migration.js';
...
describe('11. DatabaseProvider Integration', () => {
  ...
  it('auto-selects RVF when available', async () => {
    const { createDatabase, getAvailableProviders } = await import('../v3/@cortex-agent/memory/src/database-provider.js');
  ...
  it('converts .db extension to .rvf', async () => {
    const { createDatabase } = await import('../v3/@cortex-agent/memory/src/database-provider.js');
