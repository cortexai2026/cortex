...
```bash
npx cortex-agent hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
npx cortex-agent hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
npx cortex-agent hook pre-edit --file "path/to/file.js" --validate-syntax
```
