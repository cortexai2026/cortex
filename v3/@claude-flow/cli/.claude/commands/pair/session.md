...
```bash
cortex-agent pair --list
```

### Switch Between Sessions
```bash
cortex-agent pair --switch <session-id>
```

### Merge Sessions
```bash
cortex-agent pair --merge <session-1> <session-2>
```
...
### Manual Recovery
```bash
cortex-agent pair --recover [--point <timestamp>]
```

### Crash Recovery
```bash
cortex-agent pair --crash-recovery
```
...
### Share with Team
```bash
cortex-agent pair --share <session-id> \
  --team <team-id>
```

### Export for Review
```bash
cortex-agent pair --export-review <session-id>
```

### Create Learning Material
```bash
cortex-agent pair --create-tutorial <session-id>
```
