---
name: agent-types
description: Complete guide to all 87 available agent types in Cortex Agent V3
type: reference
---

# Agent Types Reference

Complete guide to all 87 available agent types in Cortex Agent V3.
...
npx cortex-agent agent spawn --help

# Spawn any agent
npx cortex-agent agent spawn -t <agent-type>
```
