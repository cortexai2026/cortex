...
npx cortex-agent sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
npx cortex-agent@alpha sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx cortex-agent sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx cortex-agent sparc run refinement-optimization-mode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If cortex-agent is installed locally
./cortex-agent sparc run refinement-optimization-mode "optimize database queries"
```
...
```bash
# Store mode-specific context
npx cortex-agent memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx cortex-agent memory query "refinement-optimization-mode" --limit 5
```
