...
npx cortex-agent sparc run supabase-admin "create user authentication schema"

# For alpha features
npx cortex-agent@alpha sparc run supabase-admin "create user authentication schema"

# With namespace
npx cortex-agent sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
npx cortex-agent sparc run supabase-admin "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If cortex-agent is installed locally
./cortex-agent sparc run supabase-admin "create user authentication schema"
```
...
```bash
# Store mode-specific context
npx cortex-agent memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
npx cortex-agent memory query "supabase-admin" --limit 5
```
