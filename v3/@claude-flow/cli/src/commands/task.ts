/**
 * V3 CLI Task Command
 * Task management for Cortex Agent
 */
...
export const taskCommand: Command = {
  ...
  options: [],
  examples: [
    { command: 'cortex-agent task create -t implementation -d "Add user auth"', description: 'Create a task' },
    { command: 'cortex-agent task list', description: 'List pending/running tasks' },
    { command: 'cortex-agent task list --all', description: 'List all tasks' },
    { command: 'cortex-agent task status task-123', description: 'Get task details' },
    { command: 'cortex-agent task cancel task-123', description: 'Cancel a task' },
    { command: 'cortex-agent task assign task-123 --agent coder-1', description: 'Assign task to agent' },
    { command: 'cortex-agent task retry task-123', description: 'Retry a failed task' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln('Usage: cortex-agent task <subcommand> [options]');
    output.writeln();
    ...
    output.writeln();
    output.writeln('Run "cortex-agent task <subcommand> --help" for subcommand help');
