...
export const autopilotCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent autopilot status', description: 'Show current state and progress' },
    { command: 'cortex-agent autopilot enable', description: 'Enable persistent completion' },
    { command: 'cortex-agent autopilot config --max-iterations 100 --timeout 180', description: 'Configure limits' },
    { command: 'cortex-agent autopilot predict', description: 'Get recommended next action' },
  ],
  action: async (): Promise<CommandResult> => {
