...
const preEditCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks pre-edit -f src/utils.ts', description: 'Get context before editing' },
    { command: 'cortex-agent hooks pre-edit -f src/api.ts -o refactor', description: 'Pre-edit with operation type' }
  ],
...
const postEditCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks post-edit -f src/utils.ts --success true', description: 'Record successful edit' },
    { command: 'cortex-agent hooks post-edit -f src/api.ts --success false -o "Type error"', description: 'Record failed edit' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    // Default file to 'unknown' for backward compatibility (env var may be empty)
    const filePath = ctx.args[0] || ctx.flags.file as string || 'unknown';
...
const preCommandCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks pre-command -c "rm -rf dist"', description: 'Assess command risk' },
    { command: 'cortex-agent hooks pre-command -c "npm install lodash"', description: 'Check package install' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const postCommandCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks post-command -c "npm test" --success true', description: 'Record successful test run' },
    { command: 'cortex-agent hooks post-command -c "npm build" --success false -e 1', description: 'Record failed build' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const command = ctx.args[0] || ctx.flags.command as string;
...
const routeCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks route -t "Fix authentication bug"', description: 'Route task to optimal agent' },
    { command: 'cortex-agent hooks route -t "Optimize database queries" -K 5', description: 'Get top 5 suggestions' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const explainCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks explain -t "Fix authentication bug"', description: 'Explain routing decision' },
    { command: 'cortex-agent hooks explain -t "Optimize queries" -a coder --verbose', description: 'Verbose explanation for specific agent' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = ctx.args[0] || ctx.flags.task as string;
...
const pretrainCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks pretrain', description: 'Pretrain with embeddings indexing' },
    { command: 'cortex-agent hooks pretrain -p ../my-project --depth deep', description: 'Deep analysis of specific project' },
    { command: 'cortex-agent hooks pretrain --no-with-embeddings', description: 'Skip embedding indexing' },
    { command: 'cortex-agent hooks pretrain --file-types ts,tsx,js', description: 'Index only TypeScript/JS files' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      output.writeln(output.dim('  Next step: Run "cortex-agent hooks build-agents" to generate optimized configs'));
...
const buildAgentsCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks build-agents', description: 'Build all agent configs' },
    { command: 'cortex-agent hooks build-agents --focus security -o ./config/agents', description: 'Build security-focused configs' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const metricsCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks metrics', description: 'View 24h metrics' },
    { command: 'cortex-agent hooks metrics --period 7d --v3-dashboard', description: 'V3 metrics for 7 days' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const transferFromProjectCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks transfer from-project -s ../old-project', description: 'Transfer all patterns' },
    { command: 'cortex-agent hooks transfer from-project -s ../prod --filter security -m 0.9', description: 'Transfer high-confidence security patterns' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const transferCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks transfer store list', description: 'List patterns from registry' },
    { command: 'cortex-agent hooks transfer store search -q routing', description: 'Search patterns' },
    { command: 'cortex-agent hooks transfer store download -p seraphine-genesis', description: 'Download pattern' },
    { command: 'cortex-agent hooks transfer store publish', description: 'Publish pattern to registry' },
    { command: 'cortex-agent hooks transfer from-project -s ../other-project', description: 'Transfer from project' },
  ],
  action: async (): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln('Run "cortex-agent hooks transfer <subcommand> --help" for details');
    return { success: true };
  }
};
...
const preTaskCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks pre-task -i task-123 -d "Fix auth bug"', description: 'Record task start' },
    { command: 'cortex-agent hooks pre-task -i task-456 -d "Implement feature" --auto-spawn', description: 'With auto-spawn' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const postTaskCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks post-task -i task-123 --success true', description: 'Record successful completion' },
    { command: 'cortex-agent hooks post-task -i task-456 --success false -q 0.3', description: 'Record failed task' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionEndCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks session-end', description: 'End and save session' },
    { command: 'cortex-agent hooks session-end --save-state false', description: 'End without saving' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionRestoreCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks session-restore', description: 'Restore latest session' },
    { command: 'cortex-agent hooks session-restore -i session-12345', description: 'Restore specific session' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const intelligenceCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks intelligence --status', description: 'Show intelligence status' },
    { command: 'cortex-agent hooks intelligence -m real-time', description: 'Enable real-time mode' },
    { command: 'cortex-agent hooks intelligence --train', description: 'Force training cycle' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerListCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks worker list', description: 'List all workers' },
    { command: 'cortex-agent hooks worker list --active', description: 'Show active instances' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerDispatchCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks worker dispatch -t optimize -c src/', description: 'Dispatch optimize worker' },
    { command: 'cortex-agent hooks worker dispatch -t audit -p critical', description: 'Security audit with critical priority' },
    { command: 'cortex-agent hooks worker dispatch -t testgaps --sync', description: 'Test coverage analysis (sync)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      if (background) {
        output.writeln();
        output.writeln(output.dim(`Check status: cortex-agent hooks worker status --id ${result.workerId}`));
      }
...
const workerStatusCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks worker status', description: 'Show running workers' },
    { command: 'cortex-agent hooks worker status --id worker_audit_1', description: 'Check specific worker' },
    { command: 'cortex-agent hooks worker status --all', description: 'Include completed workers' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerDetectCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks worker detect -p "optimize performance"', description: 'Detect triggers in prompt' },
    { command: 'cortex-agent hooks worker detect -p "security audit" --auto-dispatch', description: 'Detect and dispatch' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerCancelCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks worker cancel --id worker_audit_1', description: 'Cancel specific worker' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const workerId = ctx.flags['id'] as string;
...
const coverageRouteCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks coverage-route -t "fix bug in auth"', description: 'Route with coverage awareness' },
    { command: 'cortex-agent hooks coverage-route -t "add tests" --threshold 90', description: 'Route with custom threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = ctx.args[0] || ctx.flags.task as string;
...
const coverageSuggestCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks coverage-suggest -p src/', description: 'Suggest improvements for src/' },
    { command: 'cortex-agent hooks coverage-suggest -p src/services --threshold 90', description: 'Stricter threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const coverageGapsCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks coverage-gaps', description: 'List all coverage gaps' },
    { command: 'cortex-agent hooks coverage-gaps --critical-only', description: 'Only critical gaps' },
    { command: 'cortex-agent hooks coverage-gaps --threshold 90', description: 'Stricter threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const threshold = ctx.flags.threshold as number || 80;
...
const progressHookCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks progress', description: 'Check current progress' },
    { command: 'cortex-agent hooks progress -d', description: 'Detailed breakdown' },
    { command: 'cortex-agent hooks progress --sync', description: 'Sync progress to file' },
    { command: 'cortex-agent hooks progress --summary', description: 'Human-readable summary' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks worker list', description: 'List all workers' },
    { command: 'cortex-agent hooks worker dispatch -t optimize', description: 'Dispatch optimizer' },
    { command: 'cortex-agent hooks worker detect -p "test coverage"', description: 'Detect from prompt' },
  ],
  action: async (): Promise<CommandResult> => {
    output.writeln();
    ...
    output.writeln();
    output.writeln('Run "cortex-agent hooks worker <subcommand> --help" for details');
...
const statuslineCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks statusline', description: 'Display full statusline' },
    { command: 'cortex-agent hooks statusline --json', description: 'JSON output for hooks' },
    { command: 'cortex-agent hooks statusline --compact', description: 'Single-line status' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    function getSystemMetrics() {
      ...
      const learningJsonPaths = [
        path.join(process.cwd(), '.cortex-agent', 'learning.json'),
        path.join(process.cwd(), '.claude', '.cortex-agent', 'learning.json'),
      ...
      if (intelligencePct === 0) {
        ...
        if (fs.existsSync(path.join(process.cwd(), '.cortex-agent'))) maturityScore += 15;
        if (fs.existsSync(path.join(process.cwd(), 'CLAUDE.md'))) maturityScore += 10;
        if (fs.existsSync(path.join(process.cwd(), 'cortex-agent.config.json'))) maturityScore += 10;
    ...
    const dbPaths = [
      path.join(process.cwd(), '.swarm', 'memory.db'),
      path.join(process.cwd(), '.cortex-agent', 'memory.db'),
      path.join(process.cwd(), '.claude', 'memory.db'),
      path.join(process.cwd(), 'data', 'memory.db'),
      path.join(process.cwd(), 'memory.db'),
      path.join(process.cwd(), '.agentdb', 'memory.db'),
      path.join(process.cwd(), '.cortex-agent', 'memory', 'agentdb.db'),
    ];
    ...
    if (agentdbStats.vectorCount === 0) {
      const agentdbDirs = [
        path.join(process.cwd(), '.cortex-agent', 'agentdb'),
    ...
    const hnswPaths = [
      path.join(process.cwd(), '.cortex-agent', 'hnsw'),
    ...
    const vectorsPath = path.join(process.cwd(), '.cortex-agent', 'vectors.json');
...
const routeTaskCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks route-task --auto-swarm true', description: 'Route with auto-swarm (v2 compat)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionStartCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks session-start --auto-configure true', description: 'Start session (v2 compat)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const tokenOptimizeCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks token-optimize --stats', description: 'Show token savings stats' },
    { command: 'cortex-agent hooks token-optimize -q "auth patterns"', description: 'Get compact context' },
    { command: 'cortex-agent hooks token-optimize -A 8 --report', description: 'Config for 8 agents + report' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const modelRouteCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks model-route -t "fix typo"', description: 'Route simple task (likely haiku)' },
    { command: 'cortex-agent hooks model-route -t "architect auth system"', description: 'Route complex task (likely opus)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = ctx.args[0] || ctx.flags.task as string;
    if (!task) {
...
const modelOutcomeCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks model-outcome -t "fix typo" -m haiku -o success', description: 'Record successful haiku task' },
    { command: 'cortex-agent hooks model-outcome -t "auth system" -m sonnet -o escalated', description: 'Record escalation to opus' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const modelStatsCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks model-stats', description: 'View routing stats' },
    { command: 'cortex-agent hooks model-stats --detailed', description: 'Show detailed breakdown' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const result = await callMCPTool<{
...
const teammateIdleCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks teammate-idle --auto-assign true', description: 'Auto-assign tasks to idle teammate' },
    { command: 'cortex-agent hooks teammate-idle -t worker-1 --check-task-list', description: 'Check tasks for specific teammate' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const taskCompletedCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks task-completed -i task-123 --train-patterns', description: 'Complete task and train patterns' },
    { command: 'cortex-agent hooks task-completed -i task-456 --notify-lead --quality 0.95', description: 'Complete with quality score' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const notifyCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks notify -m "Build complete"', description: 'Send info notification' },
    { command: 'cortex-agent hooks notify -m "Test failed" -l error', description: 'Send error notification' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const hooksCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent hooks pre-edit -f src/utils.ts', description: 'Get context before editing' },
    { command: 'cortex-agent hooks route -t "Fix authentication bug"', description: 'Route task to optimal agent' },
    { command: 'cortex-agent hooks pretrain', description: 'Bootstrap intelligence from repository' },
    { command: 'cortex-agent hooks metrics --v3-dashboard', description: 'View V3 performance metrics' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    output.writeln();
    ...
    output.writeln();
    output.writeln('Usage: cortex-agent hooks <subcommand> [options]');
    output.writeln();
    output.writeln('Subcommands:');
    output.printList([
    ...
    output.writeln();
    output.writeln('Run "cortex-agent hooks <subcommand> --help" for subcommand help');
    output.writeln();
