...
export const issuesCommand: Command = {
  ...
  examples: [
    { command: 'cortex-agent issues list', description: 'List all claims' },
    { command: 'cortex-agent issues claim 123 --agent coder:coder-1', description: 'Claim as agent' },
    { command: 'cortex-agent issues handoff 123 --to agent:tester:tester-1', description: 'Handoff to tester' },
    { command: 'cortex-agent issues stealable', description: 'List stealable' },
    { command: 'cortex-agent issues steal 123 --agent coder:coder-2', description: 'Steal issue' },
    { command: 'cortex-agent issues board', description: 'Visual board' },
  ],
