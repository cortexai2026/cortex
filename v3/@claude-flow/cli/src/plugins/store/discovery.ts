...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalDownloads: plugins.reduce((sum, p) => sum + p.downloads, 0),
      totalAuthors: 1,
      featured: ['@cortex-agent/plugin-agentic-qe', '@cortex-agent/plugin-prime-radiant', '@cortex-agent/security', '@cortex-agent/claims', '@cortex-agent/teammate-plugin'],
      trending: ['@cortex-agent/plugin-agentic-qe', '@cortex-agent/plugin-prime-radiant'],
      newest: ['@cortex-agent/plugin-agentic-qe', '@cortex-agent/plugin-prime-radiant'],
      official: ['@cortex-agent/plugin-agentic-qe', '@cortex-agent/plugin-prime-radiant', '@cortex-agent/security', '@cortex-agent/claims'],
      compatibilityMatrix: [
        { pluginId: '@cortex-agent/neural', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
        { pluginId: '@cortex-agent/security', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
      ],
    };
  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      {
        id: '@cortex-agent/neural',
        name: '@cortex-agent/neural',
        ...
        dependencies: [{ name: '@cortex-agent/core', version: '^3.0.0' }],
        type: 'core',
      ...
      },
      {
        ...
        trustLevel: 'official',
        securityAudit: {
          auditor: 'cortex-agent-security-team',
      ...
      {
        id: '@cortex-agent/embeddings',
        name: '@cortex-agent/embeddings',
        ...
        minCortexAgentVersion: '3.0.0',
        dependencies: [
          { name: '@cortex-agent/core', version: '^3.0.0' },
      ...
      {
        id: '@cortex-agent/claims',
        name: '@cortex-agent/claims',
      ...
      {
        id: '@cortex-agent/performance',
        name: '@cortex-agent/performance',
      ...
      },
      {
        ...
        description: 'Analytics and metrics visualization for Cortex Agent operations',
        version: '1.2.0',
      ...
      {
        id: '@cortex-agent/plugins',
        name: '@cortex-agent/plugins',
        displayName: 'Plugin SDK',
        description: 'Unified Plugin SDK for Cortex Agent V3 - Worker, Hook, and Provider Integration. Create, test, and publish Cortex Agent plugins.',
      ...
      {
        id: '@cortex-agent/plugin-agentic-qe',
        name: '@cortex-agent/plugin-agentic-qe',
      ...
      {
        id: '@cortex-agent/plugin-prime-radiant',
        name: '@cortex-agent/plugin-prime-radiant',
      ...
      {
        id: '@cortex-agent/plugin-healthcare-clinical',
        name: '@cortex-agent/plugin-healthcare-clinical',
      ...
      {
        id: '@cortex-agent/plugin-financial-risk',
        name: '@cortex-agent/plugin-financial-risk',
      ...
      {
        id: '@cortex-agent/plugin-legal-contracts',
        name: '@cortex-agent/plugin-legal-contracts',
      ...
      {
        id: '@cortex-agent/plugin-code-intelligence',
        name: '@cortex-agent/plugin-code-intelligence',
      ...
      {
        id: '@cortex-agent/plugin-test-intelligence',
      ...
      {
        id: '@cortex-agent/plugin-perf-optimizer',
      ...
      {
        id: '@cortex-agent/plugin-neural-coordination',
        name: '@cortex-agent/plugin-neural-coordination',
      ...
      {
        id: '@cortex-agent/plugin-cognitive-kernel',
        name: '@cortex-agent/plugin-cognitive-kernel',
      ...
      {
        id: '@cortex-agent/plugin-quantum-optimizer',
        name: '@cortex-agent/plugin-quantum-optimizer',
      ...
      {
        id: '@cortex-agent/plugin-hyperbolic-reasoning',
        name: '@cortex-agent/plugin-hyperbolic-reasoning',
      ...
      {
        id: '@cortex-agent/plugin-gastown-bridge',
        name: '@cortex-agent/plugin-gastown-bridge',
      ...
      {
        id: '@cortex-agent/teammate-plugin',
        name: '@cortex-agent/teammate-plugin',
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      ...
      '@cortex-agent/teammate-plugin',
      // Domain-specific plugins
      '@cortex-agent/plugin-healthcare-clinical',
      '@cortex-agent/plugin-financial-risk',
      '@cortex-agent/plugin-legal-contracts',
      // Development intelligence plugins
      '@cortex-agent/plugin-code-intelligence',
      '@cortex-agent/plugin-test-intelligence',
      '@cortex-agent/plugin-perf-optimizer',
      // Advanced AI/reasoning plugins
      '@cortex-agent/plugin-neural-coordination',
      '@cortex-agent/plugin-cognitive-kernel',
      '@cortex-agent/plugin-quantum-optimizer',
      '@cortex-agent/plugin-hyperbolic-reasoning',
      // Gas Town Bridge
