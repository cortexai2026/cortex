...
async function demo() {
  ...
  if (pluginCreator) {
    ...
    console.log('   $ cortex-agent plugins install -n plugin-creator');
    console.log('');
  }
  ...
  console.log('   $ cortex-agent plugins list              # List all plugins');
  console.log('   $ cortex-agent plugins list --official   # Official only');
  console.log('   $ cortex-agent plugins search -q neural  # Search plugins');
  console.log('   $ cortex-agent plugins info -n plugin-creator');
  console.log('   $ cortex-agent plugins install -n plugin-creator');
  console.log('');
}
