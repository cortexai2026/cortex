...
async function main() {
  ...
  if (failed === 0) {
    ...
    console.log('    npx @cortex-agent/cli patterns list');
    console.log('    npx @cortex-agent/cli patterns list --featured');
    console.log('    npx @cortex-agent/cli patterns search -q "agent"');
    console.log('    npx @cortex-agent/cli patterns info -n <pattern-id>');
    console.log('');
  }
