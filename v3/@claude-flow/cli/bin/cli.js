#!/usr/bin/env node
/**
 * @cortex-agent/cli - CLI Entry Point
 *
 * Cortex Agent V3 Command Line Interface
 *
 * Auto-detects MCP mode when stdin is piped and no args provided.
 * This allows: echo '{"jsonrpc":"2.0",...}' | npx @cortex-agent/cli
 */
...
//   2. stdin is being piped AND args are "mcp start" (explicit, e.g. npx cortex-agent@alpha mcp start)
