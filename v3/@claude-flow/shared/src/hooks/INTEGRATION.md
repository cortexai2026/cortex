...
```typescript
import { createEventBus } from '@cortex-agent/shared/core';
import { createHookRegistry, createHookExecutor } from '@cortex-agent/shared/hooks';
import { EventStore } from '@cortex-agent/shared/events';
...
```typescript
import { HookEvent, HookContext } from '@cortex-agent/shared/hooks';
...
import { Plugin } from '@cortex-agent/shared';
import { HookEvent, HookPriority } from '@cortex-agent/shared/hooks';
...
```typescript
// v3/@cortex-agent/shared/src/mcp/tools/hooks.ts
