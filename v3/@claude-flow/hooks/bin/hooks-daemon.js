...
const STATE_FILE = join(process.cwd(), '.cortex-agent', 'hooks-daemon.json');

async function main() {
  const daemonManager = new DaemonManager({
    pidDirectory: join(process.cwd(), '.cortex-agent', 'pids'),
    logDirectory: join(process.cwd(), '.cortex-agent', 'logs'),
    autoRestart: true,
