 ...
 *
 * @module @cortex-agent/guidance/generators
 */
...
export function generateClaudeMd(profile: ProjectProfile): string {
  ...
  if (profile.guidanceControlPlane) {
    ...
    sections.push('');
    sections.push('This project uses `@cortex-agent/guidance` to enforce these rules programmatically.');
...
function getDefaultSkills(profile: ProjectProfile): SkillDefinition[] {
  ...
  if (profile.guidanceControlPlane) {
    skills.push({
      ...
      requires: ['@cortex-agent/guidance'],
      capabilities: [
      ...
      instructions: [
        ...
        '',
        'This project uses `@cortex-agent/guidance` to enforce CLAUDE.md rules programmatically.',
        '',
