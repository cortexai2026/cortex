 ...
 *
 * @module @cortex-agent/guidance/analyzer
 */
...
/** A single benchmark task representing a real Cortex Agent scenario */
...
// ── 20 Representative Tasks from Cortex Agent History ───────────────────────
...
function getABTasks(): ABTask[] {
  ...
  return [
    ...
    // ── Deployment (2 tasks) ──────────────────────────────────────────
    {
      ...
      prompt: 'Create a multi-stage Dockerfile for the Cortex Agent CLI. Include a build stage and a minimal runtime stage. Never include dev dependencies in production.',
      assertions: [
 ...
 *
 * The 20 tasks span 7 task classes drawn from real Cortex Agent repo history:
