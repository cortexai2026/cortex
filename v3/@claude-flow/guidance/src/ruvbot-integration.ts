 ...
 *
 * Bridges ruvbot (npm: ruvbot@0.1.8) with the @cortex-agent/guidance control
 ...
 *
 * @module @cortex-agent/guidance/ruvbot-integration
 */
...
async function requireRuvBot(): Promise<Record<string, unknown>> {
  ...
  try {
    ...
    throw new Error(
      ...
      'ruvbot is an optional peer dependency of @cortex-agent/guidance.',
    );
  }
}
...
/**
 * Bridges a ruvbot instance with the @cortex-agent/guidance control plane.
 *
