...
Generated: 2026-02-01 by `@cortex-agent/guidance/analyzer`
...
cd v3/@cortex-agent/guidance

# Run the analysis script
npx tsx scripts/analyze-claude-md.ts

# Or use the API programmatically
import { analyze, autoOptimize, formatReport } from '@cortex-agent/guidance/analyzer';
