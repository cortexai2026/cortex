...
```ts
import { createThreatDetector } from '@cortex-agent/guidance/adversarial';
...
```ts
import { createCollusionDetector } from '@cortex-agent/guidance/adversarial';
...
```ts
import { createMemoryQuorum } from '@cortex-agent/guidance/adversarial';
...
```ts
import { createTrustSystem } from '@cortex-agent/guidance/trust';
...
```ts
import { createAuthorityGate } from '@cortex-agent/guidance/authority';
