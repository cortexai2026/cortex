# Getting Started with @cortex-agent/guidance
...
```bash
npm install @cortex-agent/guidance@v3alpha
```
...
```ts
import { getKernel, isWasmAvailable } from '@cortex-agent/guidance/wasm-kernel';
