...
- `v3/@cortex-agent/guidance/src/gates.ts` -- `EnforcementGates.aggregateDecision()`, stateless evaluation methods
- `v3/@cortex-agent/guidance/src/ledger.ts` -- `RunLedger.createEvent()`, `DiffQualityEvaluator`
- `v3/@cortex-agent/guidance/src/index.ts` -- `GuidanceControlPlane.evaluateCommand()`, `evaluateToolUse()`, `evaluateEdit()`
- `v3/@cortex-agent/guidance/src/types.ts` -- `GateDecision`, `GateResult`
