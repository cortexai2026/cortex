...
- `v3/@cortex-agent/guidance/src/headless.ts` -- `HeadlessRunner`, `TestTask`, `TaskAssertion`, `SuiteRunSummary`, `ProcessExecutor`, `createComplianceSuite()`
- `v3/@cortex-agent/guidance/src/types.ts` -- `RunEvent`, `Violation`, `EvaluatorResult`
- `v3/@cortex-agent/guidance/src/ledger.ts` -- `RunLedger.createEvent()`, `finalizeEvent()`, `evaluate()`
- `v3/@cortex-agent/guidance/src/index.ts` -- `GuidanceControlPlane.getHeadlessRunner()`
