...
- `v3/@cortex-agent/guidance/src/types.ts` -- `RunEvent`, `Violation`, `EvaluatorResult`, `ViolationRanking`, `OptimizationMetrics`
- `v3/@cortex-agent/guidance/src/ledger.ts` -- `RunLedger`, all evaluator classes
- `v3/@cortex-agent/guidance/src/compiler.ts` -- `hashContent()` for guidance hash generation
- `v3/@cortex-agent/guidance/src/index.ts` -- `GuidanceControlPlane.startRun()`, `finalizeRun()`
