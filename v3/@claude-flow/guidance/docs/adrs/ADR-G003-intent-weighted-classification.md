...
- `v3/@cortex-agent/guidance/src/retriever.ts` -- `INTENT_PATTERNS` map, `ShardRetriever.classifyIntent()`
- `v3/@cortex-agent/guidance/src/types.ts` -- `TaskIntent` union type
