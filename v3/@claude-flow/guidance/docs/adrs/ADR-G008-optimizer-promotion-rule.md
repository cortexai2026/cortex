...
- `v3/@cortex-agent/guidance/src/optimizer.ts` -- `OptimizerLoop.runCycle()`, `proposeChanges()`, `evaluateChange()`, `applyPromotions()`, `promotionTracker`
- `v3/@cortex-agent/guidance/src/types.ts` -- `RuleChange`, `ABTestResult`, `OptimizationMetrics`, `ViolationRanking`, `RuleADR`
- `v3/@cortex-agent/guidance/src/ledger.ts` -- `RunLedger.rankViolations()`, `computeMetrics()`
- `v3/@cortex-agent/guidance/src/index.ts` -- `GuidanceControlPlane.optimize()`
