...
```ts
import type { RunEvent } from '@cortex-agent/guidance';
...
// Later, restore it
import { ProofChain } from '@cortex-agent/guidance/proof';
...
```ts
import { createTruthAnchorStore } from '@cortex-agent/guidance/truth-anchors';
