...
```ts
import { createComplianceSuite } from '@cortex-agent/guidance/headless';
import type { TestTask } from '@cortex-agent/guidance/headless';
...
```ts
import { createHeadlessRunner } from '@cortex-agent/guidance/headless';
import { createLedger } from '@cortex-agent/guidance/ledger';
...
} from '@cortex-agent/guidance/ledger';
...
import { createGuidanceControlPlane } from '@cortex-agent/guidance';
import { createComplianceSuite } from '@cortex-agent/guidance/headless';
...
```ts
import { createOptimizer } from '@cortex-agent/guidance/optimizer';
...
```ts
import { createPersistentLedger, createEventStore } from '@cortex-agent/guidance/persistence';

const store = createEventStore({ dataDir: './.cortex-agent/guidance/events' });
...
// Event is now on disk at .cortex-agent/guidance/events/
