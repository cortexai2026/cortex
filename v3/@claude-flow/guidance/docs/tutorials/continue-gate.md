...
```ts
import { createCoherenceScheduler } from '@cortex-agent/guidance/coherence';
...
```ts
import { createEconomicGovernor } from '@cortex-agent/guidance/coherence';
...
```ts
import { createContinueGate } from '@cortex-agent/guidance/continue-gate';
import { createCoherenceScheduler, createEconomicGovernor } from '@cortex-agent/guidance/coherence';
