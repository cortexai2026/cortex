/**
 * @cortex-agent/codex - config.toml Generator
 *
...
export async function generateConfigToml(options: ExtendedConfigTomlOptions = {}): Promise<string> {
  ...
  // Header
  lines.push('# =============================================================================');
  lines.push('# Cortex Agent V3 - Codex Configuration');
  lines.push('# =============================================================================');
  lines.push('# Generated by: @cortex-agent/codex');
  lines.push('# Documentation: https://github.com/ruvnet/cortex-agent');
  lines.push('# ');
  lines.push('# This file configures the Codex CLI for Cortex Agent integration.');
  ...
  // MCP Servers
  if (mcpServers.length > 0 || true) { // Always include cortex-agent by default
    lines.push('# =============================================================================');
    ...
    const hasCortexAgent = mcpServers.some(s => s.name === 'cortex-agent');
    if (!hasCortexAgent) {
  ...
  if (logging.filePath || logging.destination === 'file' || logging.destination === 'both') {
    ...
    lines.push(`file_path = "${logging.filePath ?? './logs/cortex-agent.log'}"`);
    lines.push('');
...
export async function generateMinimalConfigToml(options: ConfigTomlOptions = {}): Promise<string> {
  ...
  return `# Cortex Agent V3 - Minimal Codex Configuration
...
export async function generateEnterpriseConfigToml(): Promise<string> {
  return `# =============================================================================
# Cortex Agent V3 - Enterprise Configuration
# =============================================================================
...
format = "json"
destination = "both"
file_path = "./logs/cortex-agent.log"
max_files = 30
max_size = "50MB"
...
export async function generateDevConfigToml(): Promise<string> {
  return `# =============================================================================
# Cortex Agent V3 - Development Configuration
# =============================================================================
...
export async function generateSecureConfigToml(): Promise<string> {
  return `# =============================================================================
# Cortex Agent V3 - Security-Focused Configuration
# =============================================================================
