...
npx cortex-agent sparc run architect "design microservices"

# 2. Implementation
npx cortex-agent sparc run coder "implement services"

# 3. Testing
npx cortex-agent sparc run tdd "test all services"

# 4. Review
npx cortex-agent sparc run reviewer "review implementation"
```
...
```bash
# 1. Research phase
npx cortex-agent sparc run researcher "research best practices"

# 2. Innovation
npx cortex-agent sparc run innovator "propose novel solutions"

# 3. Documentation
npx cortex-agent sparc run documenter "document findings"
```
