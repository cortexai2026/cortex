...
npx cortex-agent sparc run tutorial "guide me through SPARC methodology"

# For alpha features
npx cortex-agent@alpha sparc run tutorial "guide me through SPARC methodology"

# With namespace
npx cortex-agent sparc run tutorial "your task" --namespace tutorial

# Non-interactive mode
npx cortex-agent sparc run tutorial "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If cortex-agent is installed locally
./cortex-agent sparc run tutorial "guide me through SPARC methodology"
```
...
```bash
# Store mode-specific context
npx cortex-agent memory store "tutorial_context" "important decisions" --namespace tutorial

# Query previous work
npx cortex-agent memory query "tutorial" --limit 5
```
