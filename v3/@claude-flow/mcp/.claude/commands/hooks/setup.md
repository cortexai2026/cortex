...
```bash
# Test pre-edit hook
npx cortex-agent hook pre-edit --file test.js

# Test session summary
npx cortex-agent hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "npx cortex-agent hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
...
# Test specific hook
npx cortex-agent hook pre-edit --file app.js --debug
```
