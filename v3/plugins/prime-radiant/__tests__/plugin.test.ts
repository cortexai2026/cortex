...
class MockPrimeRadiantPlugin {
  ...
  constructor(metadata: Partial<PluginMetadata> = {}) {
    this.metadata = Object.freeze({
      ...
      license: 'MIT',
      wasmSize: '92KB',
      dependencies: ['@cortex-agent/memory', '@cortex-agent/security', '@cortex-agent/coordination'],
      tags: [
        'sheaf-cohomology',
        'causal-inference',
        'quantum-topology',
...
describe('PrimeRadiantPlugin', () => {
  ...
  describe('metadata', () => {
    ...
    it('should have required dependencies', () => {
      ...
      expect(plugin.metadata.dependencies).toContain('@cortex-agent/coordination');
    });
