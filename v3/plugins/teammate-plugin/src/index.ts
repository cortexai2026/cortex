 ...
 *
 * Native TeammateTool integration plugin for Cortex Agent.
 * Bridges Claude Code v2.1.19+ multi-agent capabilities with Cortex Agent.
 *
 * @example
 * ```typescript
 ...
 * ```
 *
 * @module @cortex-agent/teammate-plugin
