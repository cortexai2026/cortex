 ...
 * - register(): Register with cortex-agent plugin system
...
// ============================================================================
// Plugin Interfaces (matching cortex-agent plugin system)
// ============================================================================
...
/**
 * Gas Town Bridge Plugin for Cortex Agent V3
 *
...
export class GasTownBridgePlugin extends EventEmitter implements IPlugin {
  readonly name = '@cortex-agent/plugin-gastown-bridge';
  ...
  /**
   * Register the plugin with cortex-agent
   */
