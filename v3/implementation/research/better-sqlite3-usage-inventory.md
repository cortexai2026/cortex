...
**File**: `/home/user/cortex-agent/src/memory/sqlite-wrapper.js`
...
**File**: `/home/user/cortex-agent/src/api/database-service.ts`
- **Line**: 559
...
**File**: `/home/user/cortex-agent/src/core/DatabaseManager.ts`
- **Line**: 197
...
**File**: `/home/user/cortex-agent/src/core/persistence.ts`
- **Line**: 5
...
**File**: `/home/user/cortex-agent/src/memory/backends/sqlite.ts`
...
**File**: `/home/user/cortex-agent/src/memory/sqlite-store.js`
- **Line**: 10
...
**File**: `/home/user/cortex-agent/src/cli/simple-commands/hive-mind.js`
- **Lines**: 38, 46
...
**File**: `/home/user/cortex-agent/src/cli/simple-commands/hive-mind-wizard.js`
- **Line**: 4
...
**File**: `/home/user/cortex-agent/src/cli/simple-commands/hive-mind/memory.js`
- **Line**: 7
...
**File**: `/home/user/cortex-agent/src/cli/simple-commands/hive-mind/metrics-reader.js`
- **Line**: 6
- **Usage**: ES module import
- **Migration**: Use abstraction layer
...
**File**: `/home/user/cortex-agent/src/cli/simple-commands/hive-mind/db-optimizer.js`
- **Line**: 8
- **Usage**: ES module import
- **Migration**: Use abstraction layer
...
**File**: `/home/user/cortex-agent/src/cli/simple-commands/hive-mind/mcp-wrapper.js`
- **Line**: 132
...
**File**: `/home/user/cortex-agent/src/cli/simple-commands/init/hive-mind-init.js`
- **Lines**: 304, 307
...
**File**: `/home/user/cortex-agent/src/cli/simple-commands/swarm-metrics-integration.js`
- **Line**: 8
- **Usage**: ES module import
- **Migration**: Use abstraction layer
...
**File**: `/home/user/cortex-agent/src/utils/error-recovery.ts`
...
**File**: `/home/user/cortex-agent/scripts/fix-agentic-flow-sqlite.sh`
- **Line**: 6, 16, 25-26
...
**File**: `/home/user/cortex-agent/src/patches/hive-mind-timezone-fix.patch`
- **Line**: 77
...
**File**: `/home/user/cortex-agent/scripts/install-arm64.js`
- **Lines**: 9, 11
