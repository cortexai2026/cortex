...
**File**: `/home/user/cortex-agent/package.json`
...
**File**: `/home/user/cortex-agent/src/memory/backends/sqljs.ts`
...
**File**: `/home/user/cortex-agent/package.json` (files section)
...
**File**: `/home/user/cortex-agent/tests/unit/memory/sqljs-backend.test.ts`
