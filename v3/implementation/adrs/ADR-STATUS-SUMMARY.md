...
|---------|---------|------------|
| `npx @cortex-agent/cli@alpha` | v3.0.0-alpha.87 | **171 tools**, 19 categories |
| `npx cortex-agent@v3alpha` | v3.0.0-alpha.34 | **171 tools**, 19 categories |
...
| ADR-004 | Plugin Architecture | ✅ Complete | @cortex-agent/plugins |
...
| ADR | Title | Status | Notes |
|-----|-------|--------|-------|
| ADR-011 | LLM Provider System | ✅ Complete | @cortex-agent/providers |
...
| ADR-019 | Headless Runtime Package | ✅ Complete | @cortex-agent/headless for CI/CD |
...
|---------|---------|-----------|
| @cortex-agent/cli | **3.0.0-alpha.117** | 2026-01-14 |
| cortex-agent | **3.0.0-alpha.76** | 2026-01-14 |
| @cortex-agent/memory | 3.0.0-alpha.2 | 2026-01-07 |
| @cortex-agent/mcp | 3.0.0-alpha.8 | 2026-01-07 |
| @cortex-agent/neural | 3.0.0-alpha.2 | 2026-01-06 |
| @cortex-agent/security | 3.0.0-alpha.1 | 2026-01-05 |
| @cortex-agent/swarm | 3.0.0-alpha.1 | 2026-01-04 |
| @cortex-agent/hooks | 3.0.0-alpha.2 | 2026-01-06 |
| @cortex-agent/plugins | 3.0.0-alpha.2 | 2026-01-06 |
| @cortex-agent/providers | 3.0.0-alpha.1 | 2026-01-04 |
| @cortex-agent/embeddings | 3.0.0-alpha.12 | 2026-01-05 |
| @cortex-agent/shared | 3.0.0-alpha.1 | 2026-01-03 |
...
|---------|---------|--------|
| @cortex-agent/cli | 3.0.0, 3.0.1, 3.0.2 | Buggy early releases - use alpha.86+ |
...
|---------|---------|-----------|--------|
| @cortex-agent/cli | **3.0.0-alpha.87** | 2026-01-13 | ✅ Beta Ready |
| cortex-agent | **3.0.0-alpha.34** | 2026-01-13 | ✅ Beta Ready |
| @cortex-agent/memory | 3.0.0-alpha.2 | 2026-01-07 | ✅ |
| @cortex-agent/mcp | 3.0.0-alpha.8 | 2026-01-07 | ✅ |
| @cortex-agent/neural | 3.0.0-alpha.2 | 2026-01-06 | ✅ |
| @cortex-agent/security | 3.0.0-alpha.1 | 2026-01-05 | ✅ |
...
```bash
npx @cortex-agent/cli@latest hooks statusline           # Full colored output
npx @cortex-agent/cli@latest hooks statusline --json    # JSON format
npx @cortex-agent/cli@latest hooks statusline --compact # Single-line format
```
...
output.writeln(output.dim('Run "npm audit" or "cortex-agent security scan" for real vulnerability detection.'));
```
...
**Problem:** `npx cortex-agent@alpha mcp start` failed with "Cannot read properties of undefined (reading 'split')"

**Root Cause:** npm resolved `^3.0.0-alpha.84` to buggy version `3.0.2` (semver: `3.0.2 > 3.0.0-alpha.84`)

**Solution:**
1. Pinned exact version in wrapper: `"@cortex-agent/cli": "3.0.0-alpha.86"` (no caret)
2. Deprecated buggy versions: 3.0.0, 3.0.1, 3.0.2
3. Published cortex-agent@3.0.0-alpha.33 with fix
...
- Provides fix command: `rm -rf ~/.npm/_npx/* && npx -y @cortex-agent/cli@latest`

```bash
# Check version freshness
npx @cortex-agent/cli@alpha doctor -c version

# Example output when outdated:
⚠ Version Freshness: v3.0.0-alpha.84 (latest: v3.0.0-alpha.86) [npx cache stale]
  Fix: rm -rf ~/.npm/_npx/* && npx -y @cortex-agent/cli@latest
```
...
npx cortex-agent update clear-cache # Clear check cache
```
...
| neural-tools.ts | ✅ File-based | ✅ **REAL** | Real embeddings via @cortex-agent/embeddings |
...
- `neural/predict` - **REAL**: embeddings via @cortex-agent/embeddings (agentic-flow)
...
- File-based persistence in `.cortex-agent/` directory
...
- **Neural training**: Use `@cortex-agent/neural` module
