...
Cortex Agent v3 already integrates four `@ruvector/*` WASM packages for intelligence
...
Integrate `@ruvector/rvagent-wasm` as an optional dependency in `@cortex-agent/cli`,
