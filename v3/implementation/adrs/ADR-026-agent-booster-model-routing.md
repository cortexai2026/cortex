...
```typescript
// v3/@cortex-agent/cli/src/ruvector/model-router.ts
...
```typescript
// v3/@cortex-agent/cli/src/commands/hooks.ts (update preTaskCommand)
...
```typescript
// v3/@cortex-agent/cli/src/mcp-tools/agent-tools.ts (update determineAgentModel)
