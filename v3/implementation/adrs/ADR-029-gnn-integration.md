...
```typescript
// v3/@cortex-agent/gnn/src/layers/gcn.ts
...
```typescript
// v3/@cortex-agent/gnn/src/layers/gat.ts
...
```typescript
// v3/@cortex-agent/gnn/src/layers/graphsage.ts
...
```typescript
// v3/@cortex-agent/gnn/src/layers/mpnn.ts
...
```typescript
// v3/@cortex-agent/gnn/src/layers/edge-conv.ts
...
```typescript
// v3/@cortex-agent/gnn/src/data/node-embeddings.ts
...
```typescript
// v3/@cortex-agent/gnn/src/data/edge-features.ts
...
```typescript
// v3/@cortex-agent/gnn/src/data/graph-representation.ts
...
```typescript
// v3/@cortex-agent/gnn/src/use-cases/codebase-graph.ts
...
```typescript
// v3/@cortex-agent/gnn/src/use-cases/agent-graph.ts
...
```typescript
// v3/@cortex-agent/gnn/src/use-cases/pattern-propagation.ts
...
```typescript
// v3/@cortex-agent/gnn/src/use-cases/impact-analysis.ts
...
```typescript
// v3/@cortex-agent/gnn/src/integration/memory-integration.ts
...
```typescript
// v3/@cortex-agent/gnn/src/integration/plugin-graph.ts
...
```typescript
// v3/@cortex-agent/gnn/src/integration/swarm-optimization.ts
...
```typescript
// v3/@cortex-agent/gnn/src/utils/sparse.ts
...
```typescript
// v3/@cortex-agent/gnn/src/utils/batching.ts
...
```typescript
// v3/@cortex-agent/gnn/src/utils/gpu.ts
...
```typescript
// v3/@cortex-agent/gnn/src/types/index.ts
