...
- `v3/@cortex-agent/cli/package.json` -- optionalDependencies declarations
- `v3/@cortex-agent/cli/src/hooks/` -- hooks route command
- `v3/@cortex-agent/cli/src/mcp/tools/` -- MCP tool definitions for rvagent and ruvllm
