...
ADR-003 mandates a **single canonical coordination engine** for cortex-agent v3. This document tracks the implementation of consolidating `UnifiedSwarmCoordinator` + `SwarmHub` into a unified approach.
...
**Location**: `/workspaces/cortex-agent/v3/@cortex-agent/swarm/src/unified-coordinator.ts`
...
**Location**: `/workspaces/cortex-agent/v3/@cortex-agent/swarm/src/coordination/swarm-hub.ts`
...
**Location**: `/workspaces/cortex-agent/v3/coordination/swarm-hub.ts`
 ...
 * /workspaces/cortex-agent/v3/@cortex-agent/swarm/src/coordination/swarm-hub.ts
 */
```
