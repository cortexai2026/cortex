...
**File**: `/workspaces/cortex-agent/v3/@cortex-agent/swarm/src/unified-coordinator.ts`
...
**File**: `/workspaces/cortex-agent/v3/@cortex-agent/swarm/src/coordination/swarm-hub.ts`
...
**File**: `/workspaces/cortex-agent/v3/coordination/swarm-hub.ts`
...
| `@cortex-agent/swarm/README.md` | Module documentation | ✅ Created |
