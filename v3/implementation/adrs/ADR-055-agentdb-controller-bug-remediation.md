...
- `v3/@cortex-agent/memory/src/controller-registry.ts` — 8 controllers upgraded from stub/null to real instantiation, added `createEmbeddingService()` helper
- `v3/@cortex-agent/cli/src/memory/memory-bridge.ts` — Bridge functions detect real vs stub API, updated recall/store/consolidate signatures
- `v3/@cortex-agent/cli/src/mcp-tools/agentdb-tools.ts` — Tier enum, input validation (phase 1)
- `v3/@cortex-agent/memory/package.json` — agentdb dependency `^3.0.0-alpha.10`
