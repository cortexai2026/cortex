...
- [x] Persist to `.cortex-agent/plugins/installed.json`
...
CLI Commands (plugins.ts)
    ...
    └── PluginManager (manager.ts)
            │
            ├── InstalledPlugins manifest (.cortex-agent/plugins/installed.json)
...
- [Plugin Interface](../../@cortex-agent/plugins/src/core/plugin-interface.ts)
- [Plugin Registry](../../@cortex-agent/plugins/src/registry/plugin-registry.ts)
- [Plugin Manager (CLI)](../../@cortex-agent/cli/src/plugins/manager.ts)
- [Collection Manager](../../@cortex-agent/plugins/src/collections/collection-manager.ts)
- [Dependency Graph](../../@cortex-agent/plugins/src/registry/dependency-graph.ts)
- [Official Collections](../../@cortex-agent/plugins/src/collections/official/index.ts)
