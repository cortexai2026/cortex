...
beforeAll(async () => {
  ...
  process.env.CORTEX_AGENT_ENV = 'test';
  process.env.CORTEX_AGENT_MEMORY_PATH = TEST_DB_DIR;
...
afterAll(async () => {
  ...
  delete process.env.CORTEX_AGENT_ENV;
  delete process.env.CORTEX_AGENT_MEMORY_PATH;
});
