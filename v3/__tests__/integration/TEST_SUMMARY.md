...
Comprehensive integration test suite for cortex-agent V3 with **75 tests** across **5 test files** covering all major architectural components and their interactions.
...
# Verbose output
DEBUG=cortex-agent:* npm run test:integration
