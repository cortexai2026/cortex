...
function addTestSections(writer: RvfaWriter): void {
  ...
  writer.addSection('cortex-agent', Buffer.from('cortex-agent-payload'), { compression: 'none' });
}
...
describe('RvfaWriter', () => {
  ...
  it('section offsets are correct and non-overlapping', () => {
    ...
    writer.addSection('cortex-agent', Buffer.from('ccccccc'), { compression: 'none' });
...
describe('RvfaReader', () => {
  ...
  it('handles multiple sections', () => {
    ...
    writer.addSection('cortex-agent', Buffer.from('f'), { compression: 'none' });
