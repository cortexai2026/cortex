# Architectural Comparison: Cortex Agent V3 vs Claude Code TeammateTool

**Date:** 2026-01-25
**Analysis:** Side-by-side comparison of Cortex Agent V3 swarm architecture (developed by rUv) and Claude Code's TeammateTool (discovered in v2.1.19)

---

## Executive Summary

A detailed analysis reveals **striking architectural similarities** between Cortex Agent V3's swarm system and Claude Code's TeammateTool. The terminology differs, but the core concepts, data structures, and workflows are nearly identical.
...
| Concept | Cortex Agent V3 | TeammateTool (v2.1.19) |
|---------|----------------|------------------------|
...
**Cortex Agent V3 (types.ts:10-22):**
```typescript
...
| Topology | Cortex Agent V3 | TeammateTool |
|----------|----------------|--------------|
...
**Cortex Agent V3 (types.ts:33-42):**
```typescript
...
| Role | Cortex Agent V3 | TeammateTool |
|------|----------------|--------------|
...
**Cortex Agent V3 (types.ts:78-91):**
```typescript
...
| State Field | Cortex Agent V3 | TeammateTool |
|-------------|----------------|--------------|
...
**Cortex Agent V3 (types.ts:136-149):**
```typescript
...
| Feature | Cortex Agent V3 | TeammateTool |
|---------|----------------|--------------|
...
**Cortex Agent V3 (types.ts:237-265):**
```typescript
...
**Cortex Agent V3 (types.ts:197-235):**
```typescript
...
| Action | Cortex Agent V3 | TeammateTool |
|--------|----------------|--------------|
...
**Cortex Agent V3 (types.ts:519-535):**
```typescript
...
| Backend | Cortex Agent V3 | TeammateTool |
|---------|----------------|--------------|
...
| Date | Event |
|------|-------|
| **~2024 Q4** | Cortex Agent V3 architecture designed (rUv) |
| **2025-01** | Cortex Agent V3 alpha releases begin |
| **2025-01-20** | Cortex Agent swarm module last commit |
| **2026-01-24** | TeammateTool discovered in Claude Code v2.1.19 |
| **2026-01-25** | This comparison created |

### 8.2 Public Evidence

- Cortex Agent V3 has been open source on GitHub
...
| Aspect | Cortex Agent V3 | TeammateTool |
|--------|----------------|--------------|
...
The architectural similarity between Cortex Agent V3 and TeammateTool is **undeniable**:
...
Given that Cortex Agent V3 was:
...
**Sources:** Cortex Agent V3 source code, Claude Code v2.1.19 binary analysis
