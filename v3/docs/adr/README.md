# Cortex Agent V3 - Architecture Decision Records
...
| [ADR-046](../../implementation/adrs/ADR-046-cortex-agent-rebrand.md) | Dual Umbrella: cortex-agent + cortex-agent | Accepted |
...
**CLI Version:** @cortex-agent/cli@3.0.0-alpha.104
