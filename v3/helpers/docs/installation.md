# Cortex Agent V3 Helper System Installation Guide
...
cp -r /path/to/cortex-agent/v3/helpers/ your-project/.claude/helpers/
...
# Copy helpers
cp -r /path/to/cortex-agent/v3/helpers/* .claude/helpers/
...
# Validate setup
./.claude/helpers/cortex-agent-v3.sh validate
```
...
# Validate setup
.\.claude\helpers\cortex-agent-v3.ps1 validate
```
...
```bash
# Linux/macOS
export CORTEX_AGENT_V3_MODE=enabled
export CORTEX_AGENT_HELPERS_DIR=.claude/helpers
export CORTEX_AGENT_PLATFORM=auto

# Windows (PowerShell)
$env:CORTEX_AGENT_V3_MODE = "enabled"
$env:CORTEX_AGENT_HELPERS_DIR = ".claude\helpers"
$env:CORTEX_AGENT_PLATFORM = "auto"
```
...
```bash
# Linux/macOS
./.claude/helpers/cortex-agent-v3.sh platform-info
./.claude/helpers/cortex-agent-v3.sh status

# Windows
.\.claude\helpers\cortex-agent-v3.ps1 platform-info
...
./.claude/helpers/cortex-agent-v3.sh --version
