#!/bin/bash
# Cortex Agent V3 Configuration Validator Template (Linux/macOS)
...
echo -e "${BLUE}🔍 Cortex Agent V3 Configuration Validation${RESET}"
echo "==========================================="
echo ""

# Check required directories
echo "📁 Checking Directory Structure..."
required_dirs=(".claude" ".claude/helpers" ".cortex-agent/metrics" ".cortex-agent/security")
...
required_files=(".cortex-agent/metrics/v3-progress.json" ".cortex-agent/metrics/performance.json" ".cortex-agent/security/audit-status.json")
